...
//     /// <param name="userIdentifier">The identifier of the user to be notified.</param>
//     /// <returns>An anonymous object containing the data for the notification.</returns>
//     public override object Data(IServiceProvider serviceProvider, string? userIdentifier = null)
//     {
//         return new
//         {
