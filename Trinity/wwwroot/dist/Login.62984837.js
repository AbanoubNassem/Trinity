import { r as n, v as S, O as i, h as $e, e as N, N as Me, z as Fe, m as V, t as De, d as _e, Z as X, E as oe, P as F, C as Be, y as He, q as Ue, u as Ve, a as Ke, L as qe, c as Ze, K as ze, j as T, F as Je, b as f, H as Xe, Q as We, B as Ye } from "./main.d5262881.js";
function D() {
  ...
  if (e != null) {
    ...
    try {
      if (v = (e = e.call(t)).next, r === 0) {
        ...
        for (; !(o = (l = v.call(e)).done) && (p.push(l.value), p.length !== r); o = !0)
          ;
    } catch (x) {
      d = !0, m = x;
    } finally {
...
var K = {
  ...
  var e = K.getProps(t), l = n.exports.useState(!1), m = rt(l, 2), v = m[0], c = m[1], p = n.exports.useRef(null), o = n.exports.useRef(e.inputRef), d = function(g) {
    if (!e.disabled && !e.readOnly && e.onChange) {
      var B = b(), H = g.target instanceof HTMLDivElement || g.target instanceof HTMLSpanElement, U = g.target === o.current, z = H && g.target.checked !== B;
      if (U || z) {
      ...
      S.focus(o.current), g.preventDefault();
    }
  }, x = function() {
    c(!0);
  }, P = function() {
  ...
  var u = b(), A = i.isNotEmpty(e.tooltip), O = K.getOtherProps(e), $ = i.reduceKeys(O, S.ARIA_PROPS), M = N("p-checkbox p-component", {
...
var q = {
  ...
  var e = q.getProps(t), l = e.promptLabel || V("passwordPrompt"), m = e.weakLabel || V("weak"), v = e.mediumLabel || V("medium"), c = e.strongLabel || V("strong"), p = n.exports.useState(!1), o = j(p, 2), d = o[0], x = o[1], P = n.exports.useState(null), L = j(P, 2), b = L[0], u = L[1], A = n.exports.useState(l), O = j(A, 2), $ = O[0], M = O[1], Z = n.exports.useState(!1), _ = j(Z, 2), k = _[0], g = _[1], B = n.exports.useState(!1), H = j(B, 2), U = H[0], z = H[1], y = n.exports.useRef(null), w = n.exports.useRef(null), E = n.exports.useRef(e.inputRef), Y = n.exports.useRef(new RegExp(e.mediumRegex)), Q = n.exports.useRef(new RegExp(e.strongRegex)), ie = U ? "text" : "password", ce = De({
    target: y,
    overlay: w,
    ...
    when: d
  }), G = j(ce, 2), pe = G[0], fe = G[1], ee = E.current && E.current.value, J = n.exports.useMemo(function() {
    ...
    if (e.feedback) {
      var R = a.target.value, C = null, I = null;
      switch (Se(R)) {
        case 1:
          C = m, I = {
            strength: "weak",
    ...
    return Q.current.test(a) ? 3 : Y.current.test(a) ? 2 : a.length ? 1 : 0;
  };
  n.exports.useImperativeHandle(r, function() {
    return {
      props: e,
    ...
    Q.current = new RegExp(e.strongRegex);
  ...
  var Oe = function() {
    ...
    var a = N("p-password-panel p-component", e.panelClassName, {
      ...
      strength: "",
      width: "0%"
    }, R = h.strength, C = h.width, I = i.getJSXElement(e.header, e), Le = i.getJSXElement(e.footer, e), Ae = e.content ? i.getJSXElement(e.content, e) : /* @__PURE__ */ n.exports.createElement(n.exports.Fragment, null, /* @__PURE__ */ n.exports.createElement("div", {
  ...
  }, e.className), Pe = N("p-password-input", e.inputClassName), Ce = q.getOtherProps(e), Ie = Oe(), Te = Re();
  return /* @__PURE__ */ n.exports.createElement("div", {
    ref: y,
    id: e.id,
    className: Ne,
    style: e.style
  }, /* @__PURE__ */ n.exports.createElement(oe, W({
    ref: E,
    id: e.inputId
  }, Ce, {
    type: ie,
...
const st = () => {
  const t = Ve(), { errors: r, data: e } = Ke(), [l, m] = n.exports.useState(""), [v, c] = n.exports.useState(!1), { layoutConfig: p } = n.exports.useContext(qe), o = Ze(), d = N("surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden", { "p-input-filled": p.inputStyle === "filled" }), { data: x, setData: P, submit: L, processing: b } = ze({
    email: "",
    password: "",
    remember: !1
  });
                    ...
                    /* @__PURE__ */ T("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ f(oe, {
                          ...
                          value: x.email,
                          onChange: (u) => P("email", u.target.value),
                          style: { padding: "1rem" }
                        }),
                    ...
                    /* @__PURE__ */ T("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ f(ue, {
                          value: l,
                          onChange: (u) => {
                            m(u.target.value), P("password", u.target.value);
                          },
                        ...
                        /* @__PURE__ */ T("div", {
                          ...
                          children: [
                            /* @__PURE__ */ f(se, {
                              ...
                              onChange: (u) => {
                                var A, O;
                                c((A = u.checked) != null ? A : !1), P("remember", (O = u.checked) != null ? O : !1);
                              },
                              className: "mr-2"
                            }),
                            /* @__PURE__ */ f("label", {
