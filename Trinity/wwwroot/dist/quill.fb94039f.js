import { J as pt, K as yt } from "./main.f3b4a68a.js";
function mt(ct, ht) {
  for (var B = 0; B < ht.length; B++) {
    const _ = ht[B];
    if (typeof _ != "string" && !Array.isArray(_)) {
      for (const v in _)
        if (v !== "default" && !(v in ct)) {
          const P = Object.getOwnPropertyDescriptor(_, v);
          P && Object.defineProperty(ct, v, P.get ? P : {
            enumerable: !0,
            get: () => _[v]
          });
        }
...
(function(ct, ht) {
  (function(_, v) {
    ct.exports = v();
  })(typeof self < "u" ? self : yt, function() {
    return function(B) {
      var _ = {};
      function v(P) {
        if (_[P])
        ...
        return B[P].call(N.exports, N, N.exports, v), N.l = !0, N.exports;
      }
      return v.m = B, v.c = _, v.d = function(P, N, k) {
        v.o(P, N) || Object.defineProperty(P, N, {
          configurable: !1,
          enumerable: !0,
          get: k
        });
      }, v.n = function(P) {
        var N = P && P.__esModule ? function() {
          return P.default;
        } : function() {
          return P;
        };
      ...
      function(B, _, v) {
        ...
        var P = v(17), N = v(18), k = v(19), m = v(45), y = v(46), c = v(47), o = v(48), t = v(49), e = v(12), u = v(32), l = v(33), a = v(31), r = v(1), i = {
          Scope: r.Scope,
          create: r.create,
          find: r.find,
          query: r.query,
      ...
      function(B, _, v) {
        ...
        function t(a, r) {
          var i = u(a);
          if (i == null)
            throw new N("Unable to create " + a + " blot");
        ...
        function l() {
          ...
          if (c[i.blotName || i.attrName] = i, typeof i.keyName == "string")
            k[i.keyName] = i;
          else if (i.className != null && (m[i.className] = i), i.tagName != null) {
      ...
      function(B, _, v) {
        var P = v(51), N = v(11), k = v(3), m = v(20), y = String.fromCharCode(0), c = function(o) {
        ...
        c.prototype.insert = function(o, t) {
          ...
          for (var e = [], u = m.iterator(this.ops), l = 0; l < t && u.hasNext(); ) {
            var a;
            l < o ? a = u.next(o - l) : (a = u.next(t - l), e.push(a)), l += m.length(a);
          }
          return new c(e);
        }, c.prototype.compose = function(o) {
          var t = m.iterator(this.ops), e = m.iterator(o.ops), u = [], l = e.peek();
          ...
          for (var r = new c(u); t.hasNext() || e.hasNext(); )
            if (e.peekType() === "insert")
              ...
              if (typeof n.retain == "number") {
                ...
                var A = m.attributes.compose(f.attributes, n.attributes, typeof f.retain == "number");
                if (A && (s.attributes = A), r.push(s), !e.hasNext() && N(r.ops[r.ops.length - 1], s)) {
                  var g = new c(t.rest());
          ...
          }), u = new c(), l = P(e[0], e[1], t), a = m.iterator(this.ops), r = m.iterator(o.ops);
            ...
            for (var f = i[1].length; f > 0; ) {
              ...
              switch (i[0]) {
                ...
                case P.EQUAL:
                  ...
                  N(s.insert, A.insert) ? u.retain(n, m.attributes.diff(s.attributes, A.attributes)) : u.push(A).delete(n);
                  break;
              }
              f -= n;
            }
          ...
          t = t || `
`;
          for (var e = m.iterator(this.ops), u = new c(), l = 0; e.hasNext(); ) {
            if (e.peekType() !== "insert")
              return;
            var a = e.peek(), r = m.length(a) - e.peekLength(), i = typeof a.insert == "string" ? a.insert.indexOf(t, r) - r : -1;
            if (i < 0)
              u.push(e.next());
            else if (i > 0)
              u.push(e.next(i));
          ...
          for (var e = m.iterator(this.ops), u = m.iterator(o.ops), l = new c(); e.hasNext() || u.hasNext(); )
            if (e.peekType() === "insert" && (t || u.peekType() !== "insert"))
              ...
              if (r.delete)
                continue;
              i.delete ? l.push(i) : l.retain(a, m.attributes.transform(r.attributes, i.attributes, t));
            }
          return l.chop();
      ...
      function(B, _) {
        var v = Object.prototype.hasOwnProperty, P = Object.prototype.toString, N = Object.defineProperty, k = Object.getOwnPropertyDescriptor, m = function(e) {
        ...
        B.exports = function t() {
          ...
          for (typeof f == "boolean" && (A = f, f = arguments[1] || {}, n = 2), (f == null || typeof f != "object" && typeof f != "function") && (f = {}); n < s; ++n)
            if (e = arguments[n], e != null)
              for (u in e)
                l = o(f, u), a = o(e, u), f !== a && (A && a && (y(a) || (r = m(a))) ? (r ? (r = !1, i = l && m(l) ? l : []) : i = l && y(l) ? l : {}, c(f, { name: u, newValue: t(A, i, a) })) : typeof a < "u" && c(f, { name: u, newValue: a }));
          return f;
        };
      },
      function(B, _, v) {
        ...
        var P = function() {
          function h(d, E) {
            for (var T = 0; T < E.length; T++) {
              var q = E[T];
              q.enumerable = q.enumerable || !1, q.configurable = !0, "value" in q && (q.writable = !0), Object.defineProperty(d, q.key, q);
            }
          }
        ...
        }, k = v(3), m = f(k), y = v(2), c = f(y), o = v(0), t = f(o), e = v(16), u = f(e), l = v(6), a = f(l), r = v(7), i = f(r);
        function f(h) {
        ...
        var g = 1, b = function(h) {
          A(d, h);
          function d() {
            return n(this, d), s(this, (d.__proto__ || Object.getPrototypeOf(d)).apply(this, arguments));
          }
          return P(d, [{
            key: "attach",
            value: function() {
              N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "attach", this).call(this), this.attributes = new t.default.Attributor.Store(this.domNode);
            }
          }, {
            key: "delta",
            value: function() {
              return new c.default().insert(this.value(), (0, m.default)(this.formats(), this.attributes.values()));
            }
          }, {
            key: "format",
            value: function(T, q) {
...
`)) {
                ...
                N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "insertAt", this).call(this, T, q, D);
            }
          }]), d;
        }(t.default.Embed);
        ...
        var w = function(h) {
          ...
          function d(E) {
            n(this, d);
            var T = s(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, E));
            return T.cache = {}, T;
          }
          return P(d, [{
            key: "delta",
            value: function() {
              return this.cache.delta == null && (this.cache.delta = this.descendants(t.default.Leaf).reduce(function(T, q) {
                return q.length() === 0 ? T : T.insert(q.value(), p(q));
              }, new c.default()).insert(`
`, p(this))), this.cache.delta;
            }
          }, {
            key: "deleteAt",
            value: function(T, q) {
              N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "deleteAt", this).call(this, T, q), this.cache = {};
            }
          }, {
            key: "formatAt",
            value: function(T, q, D, C) {
              q <= 0 || (t.default.query(D, t.default.Scope.BLOCK) ? T + q === this.length() && this.format(D, C) : N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "formatAt", this).call(this, T, Math.min(q, this.length() - T - 1), D, C), this.cache = {});
            }
          }, {
            key: "insertAt",
            value: function(T, q, D) {
              if (D != null)
                return N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "insertAt", this).call(this, T, q, D);
              if (q.length !== 0) {
                var C = q.split(`
`), Z = C.shift();
                Z.length > 0 && (T < this.length() - 1 || this.children.tail == null ? N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "insertAt", this).call(this, Math.min(T, this.length() - 1), Z) : this.children.tail.insertAt(this.children.tail.length(), Z), this.cache = {});
                var I = this;
            ...
            value: function(T, q) {
              ...
              N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "insertBefore", this).call(this, T, q), D instanceof u.default && D.remove(), this.cache = {};
            }
          }, {
            key: "length",
            value: function() {
              return this.cache.length == null && (this.cache.length = N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "length", this).call(this) + g), this.cache.length;
            }
          }, {
            key: "moveChildren",
            value: function(T, q) {
              N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "moveChildren", this).call(this, T, q), this.cache = {};
            }
          }, {
            key: "optimize",
            value: function(T) {
              N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "optimize", this).call(this, T), this.cache = {};
            }
          }, {
            key: "path",
            value: function(T) {
              return N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "path", this).call(this, T, !0);
            }
          }, {
            key: "removeChild",
            value: function(T) {
              N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "removeChild", this).call(this, T), this.cache = {};
            }
          }, {
            key: "split",
            value: function(T) {
              ...
              if (q && (T === 0 || T >= this.length() - g)) {
                ...
                var C = N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "split", this).call(this, T, q);
                return this.cache = {}, C;
              }
            }
          }]), d;
        }(t.default.Block);
        w.blotName = "block", w.tagName = "P", w.defaultChild = "break", w.allowedChildren = [a.default, t.default.Embed, i.default];
        function p(h) {
          var d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          return h == null || (typeof h.formats == "function" && (d = (0, m.default)(d, h.formats())), h.parent == null || h.parent.blotName == "scroll" || h.parent.statics.scope !== h.statics.scope) ? d : p(h.parent, d);
        }
        _.bubbleFormats = p, _.BlockEmbed = b, _.default = w;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
        }), _.default = _.overload = _.expandConfig = void 0;
        var P = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(I) {
          return typeof I;
        } : function(I) {
          return I && typeof Symbol == "function" && I.constructor === Symbol && I !== Symbol.prototype ? "symbol" : typeof I;
        }, N = function() {
          function I(R, O) {
            var S = [], L = !0, F = !1, M = void 0;
            try {
        ...
        v(50);
        var m = v(2), y = p(m), c = v(14), o = p(c), t = v(8), e = p(t), u = v(9), l = p(u), a = v(0), r = p(a), i = v(15), f = p(i), n = v(3), s = p(n), A = v(10), g = p(A), b = v(34), w = p(b);
        function p(I) {
          return I && I.__esModule ? I : { default: I };
        }
        function h(I, R, O) {
          return R in I ? Object.defineProperty(I, R, { value: O, enumerable: !0, configurable: !0, writable: !0 }) : I[R] = O, I;
        }
        function d(I, R) {
          if (!(I instanceof R))
            throw new TypeError("Cannot call a class as a function");
        }
        var E = (0, g.default)("quill"), T = function() {
          k(I, null, [{
            key: "debug",
            value: function(O) {
            ...
            value: function(O, S) {
              ...
              if (typeof O != "string") {
                ...
                typeof M == "string" ? this.register("formats/" + M, O, S) : Object.keys(O).forEach(function(x) {
                  L.register(x, O[x], S);
                });
              } else
                this.imports[O] != null && !F && E.warn("Overwriting " + O + " with", S), this.imports[O] = S, (O.startsWith("blots/") || O.startsWith("formats/")) && S.blotName !== "abstract" ? r.default.register(S) : O.startsWith("modules") && typeof S.register == "function" && S.register();
            }
          }]);
          function I(R) {
            var O = this, S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            if (d(this, I), this.options = q(R, S), this.container = this.options.container, this.container == null)
            ...
            }), this.editor = new o.default(this.scroll), this.selection = new f.default(this.scroll, this.emitter), this.theme = new this.options.theme(this, this.options), this.keyboard = this.theme.addModule("keyboard"), this.clipboard = this.theme.addModule("clipboard"), this.history = this.theme.addModule("history"), this.theme.init(), this.emitter.on(e.default.events.EDITOR_CHANGE, function(M) {
              M === e.default.events.TEXT_CHANGE && O.root.classList.toggle("ql-blank", O.editor.isBlank());
            }), this.emitter.on(e.default.events.SCROLL_UPDATE, function(M, x) {
          ...
          return k(I, [{
            ...
            value: function(O, S) {
              ...
              return D.call(this, function() {
                var M = L.getSelection(!0), x = new y.default();
                if (M == null)
                  return x;
                if (r.default.query(O, r.default.Scope.BLOCK))
                  x = L.editor.formatLine(M.index, M.length, h({}, O, S));
                else {
                  if (M.length === 0)
                    return L.selection.format(O, S), x;
                  x = L.editor.formatText(M.index, M.length, h({}, O, S));
                }
            ...
            value: function(O, S, L, F, M) {
              var x = this, j = void 0, U = C(O, S, L, F, M), H = N(U, 4);
              return O = H[0], S = H[1], j = H[2], M = H[3], D.call(this, function() {
            ...
            key: "getContents",
            value: function() {
              var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.getLength() - O, L = C(O, S), F = N(L, 2);
            ...
            key: "insertEmbed",
            value: function(O, S, L) {
              var F = this, M = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : I.sources.API;
              return D.call(this, function() {
            ...
            key: "insertText",
            value: function(O, S, L, F, M) {
              var x = this, j = void 0, U = C(O, 0, L, F, M), H = N(U, 4);
              return O = H[0], j = H[2], M = H[3], D.call(this, function() {
            ...
            value: function(O) {
              ...
              return D.call(this, function() {
                O = new y.default(O);
                var F = S.getLength(), M = S.editor.deleteText(0, F), x = S.editor.applyDelta(O), j = x.ops[x.ops.length - 1];
...
` && (S.editor.deleteText(S.getLength() - 1, 1), x.delete(1));
            ...
            value: function(O, S, L) {
              if (O == null)
                ...
                var F = C(O, S, L), M = N(F, 4);
                O = M[0], S = M[1], L = M[3], this.selection.setRange(new i.Range(O, S), L), L !== e.default.sources.SILENT && this.selection.scrollIntoView(this.scrollingContainer);
              }
            }
          }, {
            key: "setText",
        ...
        function q(I, R) {
          ...
          [O, R].forEach(function(F) {
            F.modules = F.modules || {}, Object.keys(F.modules).forEach(function(M) {
              F.modules[M] === !0 && (F.modules[M] = {});
            });
          });
          var S = Object.keys(O.modules).concat(Object.keys(R.modules)), L = S.reduce(function(F, M) {
            var x = T.import("modules/" + M);
            return x == null ? E.error("Cannot load " + M + " module. Are you sure you registered it?") : F[M] = x.DEFAULTS || {}, F;
          }, {});
        ...
        function D(I, R, O, S) {
          ...
          var L = O == null ? null : this.getSelection(), F = this.editor.delta, M = I();
          if (L != null && (O === !0 && (O = L.index), S == null ? L = Z(L, M, R) : S !== 0 && (L = Z(L, O, S, R)), this.setSelection(L, e.default.sources.SILENT)), M.length() > 0) {
            var x, j = [e.default.events.TEXT_CHANGE, M, F, R];
        ...
        function C(I, R, O, S, L) {
          var F = {};
          return typeof I.index == "number" && typeof I.length == "number" ? typeof R != "number" ? (L = S, S = O, O = R, R = I.length, I = I.index) : (R = I.length, I = I.index) : typeof R != "number" && (L = S, S = O, O = R, R = 0), (typeof O > "u" ? "undefined" : P(O)) === "object" ? (F = O, L = S) : typeof O == "string" && (S != null ? F[O] = S : L = O), L = L || e.default.sources.API, [I, R, F, L];
        }
        function Z(I, R, O, S) {
          if (I == null)
            return null;
      ...
      function(B, _, v) {
        ...
        var l = function(a) {
          ...
          return P(r, [{
            key: "formatAt",
            value: function(f, n, s, A) {
              if (r.compare(this.statics.blotName, s) < 0 && c.default.query(s, c.default.Scope.BLOT)) {
                var g = this.isolate(f, n);
                A && g.wrap(s, A);
              } else
                N(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "formatAt", this).call(this, f, n, s, A);
            }
          }, {
            key: "optimize",
            value: function(f) {
              if (N(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "optimize", this).call(this, f), this.parent instanceof r && r.compare(this.statics.blotName, this.parent.statics.blotName) > 0) {
        ...
        l.allowedChildren = [l, c.default.Embed, m.default], l.order = [
          "cursor",
          "inline",
          "underline",
          "strike",
      ...
      function(B, _, v) {
        ...
        var o = function(t) {
          c(e, t);
          function e() {
            return m(this, e), y(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments));
          }
          return e;
        }(N.default.Text);
        _.default = o;
      ...
      function(B, _, v) {
        ...
        var r = function(i) {
          ...
          return P(f, [{
            key: "emit",
            value: function() {
              l.log.apply(l, arguments), N(f.prototype.__proto__ || Object.getPrototypeOf(f.prototype), "emit", this).apply(this, arguments);
            }
          }, {
            key: "handleDOM",
            value: function(s) {
              for (var A = arguments.length, g = Array(A > 1 ? A - 1 : 0), b = 1; b < A; b++)
                g[b - 1] = arguments[b];
              (this.listeners[s.type] || []).forEach(function(w) {
                var p = w.node, h = w.handler;
                (s.target === p || p.contains(s.target)) && h.apply(void 0, [s].concat(g));
              });
            }
          }, {
            key: "listenDOM",
            value: function(s, A, g) {
      ...
      function(B, _, v) {
        ...
        var N = function k(m) {
          ...
          P(this, k), this.quill = m, this.options = y;
        };
      ...
      function(B, _, v) {
        ...
        var P = ["error", "warn", "log", "info"], N = "warn";
        function k(y) {
        ...
        function m(y) {
          return P.reduce(function(c, o) {
            return c[o] = k.bind(console, o, y), c;
          }, {});
        }
        k.level = m.level = function(y) {
          N = y;
        }, _.default = m;
      },
      function(B, _, v) {
        var P = Array.prototype.slice, N = v(52), k = v(53), m = B.exports = function(t, e, u) {
        ...
        function o(t, e, u) {
          ...
          if (y(t) || y(e) || t.prototype !== e.prototype)
            return !1;
          if (k(t))
            return k(e) ? (t = P.call(t), e = P.call(e), m(t, e, u)) : !1;
          if (c(t)) {
      ...
      function(B, _, v) {
        ...
        var P = v(1), N = function() {
          ...
          return k.keys = function(m) {
            return [].map.call(m.attributes, function(y) {
              return y.name;
            });
          }, k.prototype.add = function(m, y) {
            return this.canAdd(m, y) ? (m.setAttribute(this.keyName, y), !0) : !1;
          }, k.prototype.canAdd = function(m, y) {
      ...
      function(B, _, v) {
        ...
        var P = function() {
          function b(w, p) {
            var h = [], d = !0, E = !1, T = void 0;
            try {
              for (var q = w[Symbol.iterator](), D; !(d = (D = q.next()).done) && (h.push(D.value), !(p && h.length === p)); d = !0)
                ;
            } catch (C) {
              E = !0, T = C;
            } finally {
          ...
          return function(w, p, h) {
            return p && b(w.prototype, p), h && b(w, h), w;
          };
        }(), k = function b(w, p, h) {
        ...
        }, m = v(2), y = i(m), c = v(0), o = i(c), t = v(4), e = i(t), u = v(6), l = i(u), a = v(7), r = i(a);
        function i(b) {
        ...
        var A = function(b) {
          s(w, b);
          function w() {
            return f(this, w), n(this, (w.__proto__ || Object.getPrototypeOf(w)).apply(this, arguments));
          }
          return w;
        }(l.default);
        ...
        var g = function(b) {
          ...
          return N(w, [{
            key: "delta",
            value: function() {
              var h = this, d = this.domNode.textContent;
              return d.endsWith(`
...
`, h.formats());
            ...
            value: function(h, d) {
              if (!(h === this.statics.blotName && d)) {
                var E = this.descendant(r.default, this.length() - 1), T = P(E, 1), q = T[0];
                q != null && q.deleteAt(q.length() - 1, 1), k(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "format", this).call(this, h, d);
              }
            }
          }, {
            key: "formatAt",
            value: function(h, d, E, T) {
              if (d !== 0 && !(o.default.query(E, o.default.Scope.BLOCK) == null || E === this.statics.blotName && T === this.statics.formats(this.domNode))) {
                var q = this.newlineIndex(h);
                if (!(q < 0 || q >= h + d)) {
                  var D = this.newlineIndex(h, !0) + 1, C = q - D + 1, Z = this.isolate(D, C), I = Z.next;
                  Z.format(E, T), I instanceof w && I.formatAt(0, h - D + d - C, E, T);
                }
              }
            }
          }, {
...
`)), k(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "optimize", this).call(this, h);
              var d = this.next;
              d != null && d.prev === this && d.statics.blotName === this.statics.blotName && this.statics.formats(this.domNode) === d.statics.formats(d.domNode) && (d.optimize(h), d.moveChildren(this), d.remove());
            }
          }, {
            key: "replace",
            value: function(h) {
              k(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "replace", this).call(this, h), [].slice.call(this.domNode.querySelectorAll("*")).forEach(function(d) {
                var E = o.default.find(d);
                E == null ? d.parentNode.removeChild(d) : E instanceof o.default.Embed ? E.remove() : E.unwrap();
              });
            }
          }], [{
            key: "create",
            value: function(h) {
              var d = k(w.__proto__ || Object.getPrototypeOf(w), "create", this).call(this, h);
      ...
      function(B, _, v) {
        ...
        }(), m = v(2), y = d(m), c = v(20), o = d(c), t = v(0), e = d(t), u = v(13), l = d(u), a = v(24), r = d(a), i = v(4), f = d(i), n = v(16), s = d(n), A = v(21), g = d(A), b = v(11), w = d(b), p = v(3), h = d(p);
        function d(I) {
          return I && I.__esModule ? I : { default: I };
        }
        function E(I, R, O) {
        ...
        var q = /^[ -~]*$/, D = function() {
          ...
          return k(I, [{
            ...
            value: function(O) {
              ...
              return this.scroll.batchStart(), O = Z(O), O.reduce(function(M, x) {
...
`) && (L = !0), S.scroll.insertAt(M, H);
                    var V = S.scroll.line(M), Y = N(V, 2), X = Y[0], Q = Y[1], nt = (0, h.default)({}, (0, i.bubbleFormats)(X));
                    if (X instanceof f.default) {
                      var rt = X.descendant(e.default.Leaf, Q), at = N(rt, 1), lt = at[0];
              ...
              }, 0), O.reduce(function(M, x) {
                return typeof x.delete == "number" ? (S.scroll.deleteAt(M, x.delete), M) : M + (x.retain || x.insert.length || 1);
            ...
            value: function(O, S) {
              ...
              return this.scroll.update(), Object.keys(F).forEach(function(M) {
                if (!(L.scroll.whitelist != null && !L.scroll.whitelist[M])) {
            ...
            key: "insertEmbed",
            value: function(O, S, L) {
              return this.scroll.insertAt(O, S, L), this.update(new y.default().retain(O).insert(E({}, S, L)));
            }
          }, {
            key: "insertText",
            value: function(O, S) {
              ...
              return S = S.replace(/\r\n/g, `
`).replace(/\r/g, `
`), this.scroll.insertAt(O, S), Object.keys(F).forEach(function(M) {
            ...
            key: "removeFormat",
            value: function(O, S) {
              var L = this.getText(O, S), F = this.scroll.line(O + S), M = N(F, 2), x = M[0], j = M[1], U = 0, H = new y.default();
...
`));
            ...
            value: function(O) {
              ...
              if (S.length === 1 && S[0].type === "characterData" && S[0].target.data.match(q) && e.default.find(S[0].target)) {
                var M = e.default.find(S[0].target), x = (0, i.bubbleFormats)(M), j = M.offset(this.scroll), U = S[0].oldValue.replace(r.default.CONTENTS, ""), H = new y.default().insert(U), V = new y.default().insert(M.value()), Y = new y.default().retain(j).concat(H.diff(V, L));
                O = Y.reduce(function(X, Q) {
                  return Q.insert ? X.insert(Q.insert, x) : X.push(Q);
                }, new y.default()), this.delta = F.compose(O);
              } else
                this.delta = this.getDelta(), (!O || !(0, w.default)(F.compose(O), this.delta)) && (O = F.diff(this.delta, L));
              return O;
            }
          }]), I;
        }();
        function C(I, R) {
          return Object.keys(R).reduce(function(O, S) {
            return I[S] == null || (R[S] === I[S] ? O[S] = R[S] : Array.isArray(R[S]) ? R[S].indexOf(I[S]) < 0 && (O[S] = R[S].concat([I[S]])) : O[S] = [R[S], I[S]]), O;
          }, {});
        }
        function Z(I) {
...
`);
      ...
      function(B, _, v) {
        ...
        }(), k = v(0), m = r(k), y = v(21), c = r(y), o = v(11), t = r(o), e = v(8), u = r(e), l = v(10), a = r(l);
        function r(b) {
          return b && b.__esModule ? b : { default: b };
        }
        function i(b) {
          if (Array.isArray(b)) {
            for (var w = 0, p = Array(b.length); w < b.length; w++)
              p[w] = b[w];
            return p;
          } else
            return Array.from(b);
        ...
        var n = (0, a.default)("quill:selection"), s = function b(w) {
          var p = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
          f(this, b), this.index = w, this.length = p;
        }, A = function() {
          function b(w, p) {
            var h = this;
            f(this, b), this.emitter = p, this.scroll = w, this.composing = !1, this.mouseDown = !1, this.root = this.scroll.domNode, this.cursor = m.default.create("cursor", this), this.lastRange = this.savedRange = new s(0, 0), this.handleComposition(), this.handleDragging(), this.emitter.listenDOM("selectionchange", document, function() {
              h.mouseDown || setTimeout(h.update.bind(h, u.default.sources.USER), 1);
            }), this.emitter.on(u.default.events.EDITOR_CHANGE, function(d, E) {
              d === u.default.events.TEXT_CHANGE && E.length() > 0 && h.update(u.default.sources.SILENT);
            }), this.emitter.on(u.default.events.SCROLL_BEFORE_UPDATE, function() {
              if (!!h.hasFocus()) {
                var d = h.getNativeRange();
                d != null && d.start.node !== h.cursor.textNode && h.emitter.once(u.default.events.SCROLL_UPDATE, function() {
                  try {
                    h.setNativeRange(d.start.node, d.start.offset, d.end.node, d.end.offset);
                  } catch {
                  }
                });
              }
            }), this.emitter.on(u.default.events.SCROLL_OPTIMIZE, function(d, E) {
              if (E.range) {
                var T = E.range, q = T.startNode, D = T.startOffset, C = T.endNode, Z = T.endOffset;
          ...
          return N(b, [{
            ...
            value: function() {
              ...
              this.root.addEventListener("compositionstart", function() {
                ...
                if (p.composing = !1, p.cursor.parent) {
                  var h = p.cursor.restore();
                  if (!h)
                    return;
                  setTimeout(function() {
                    p.setNativeRange(h.startNode, h.startOffset, h.endNode, h.endOffset);
                  }, 1);
                }
              });
            }
            ...
            value: function() {
              ...
              this.emitter.listenDOM("mousedown", document.body, function() {
                ...
                p.mouseDown = !1, p.update(u.default.sources.USER);
              });
            }
          }, {
            key: "focus",
            ...
            key: "format",
            value: function(p, h) {
              if (!(this.scroll.whitelist != null && !this.scroll.whitelist[p])) {
                this.scroll.update();
                var d = this.getNativeRange();
                if (!(d == null || !d.native.collapsed || m.default.query(p, m.default.Scope.BLOCK))) {
                  if (d.start.node !== this.cursor.textNode) {
                    ...
                    if (E instanceof m.default.Leaf) {
                      ...
                      E.insertBefore(this.cursor, d.start.node);
                    this.cursor.attach();
                  }
                  this.cursor.format(p, h), this.scroll.optimize(), this.setNativeRange(this.cursor.textNode, this.cursor.textNode.data.length), this.update();
                }
              }
            }
          }, {
            key: "getBounds",
            value: function(p) {
              var h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, d = this.scroll.length();
              p = Math.min(p, d - 1), h = Math.min(p + h, d - 1) - p;
              var E = void 0, T = this.scroll.leaf(p), q = P(T, 2), D = q[0], C = q[1];
              if (D == null)
                return null;
              var Z = D.position(C, !0), I = P(Z, 2);
              E = I[0], C = I[1];
              var R = document.createRange();
              if (h > 0) {
                R.setStart(E, C);
                var O = this.scroll.leaf(p + h), S = P(O, 2);
                ...
                var M = "left", x = void 0;
                return E instanceof Text ? (C < E.data.length ? (R.setStart(E, C), R.setEnd(E, C + 1)) : (R.setStart(E, C - 1), R.setEnd(E, C), M = "right"), x = R.getBoundingClientRect()) : (x = D.domNode.getBoundingClientRect(), C > 0 && (M = "right")), {
            ...
            value: function() {
              ...
              if (p == null || p.rangeCount <= 0)
                return null;
              var h = p.getRangeAt(0);
              if (h == null)
                return null;
            ...
            value: function() {
              ...
              if (p == null)
                return [null, null];
              var h = this.normalizedToRange(p);
              return [h, p];
            }
          }, {
            key: "hasFocus",
            ...
            value: function(p) {
              var h = this, d = [[p.start.node, p.start.offset]];
              p.native.collapsed || d.push([p.end.node, p.end.offset]);
              var E = d.map(function(D) {
                var C = P(D, 2), Z = C[0], I = C[1], R = m.default.find(Z, !0), O = R.offset(h.scroll);
                return I === 0 ? O : R instanceof m.default.Container ? O + R.length() : O + R.index(Z, I);
            ...
            key: "normalizeNative",
            value: function(p) {
              if (!g(this.root, p.startContainer) || !p.collapsed && !g(this.root, p.endContainer))
                return null;
              var h = {
                start: { node: p.startContainer, offset: p.startOffset },
                end: { node: p.endContainer, offset: p.endOffset },
                native: p
              };
              return [h.start, h.end].forEach(function(d) {
                for (var E = d.node, T = d.offset; !(E instanceof Text) && E.childNodes.length > 0; )
            ...
            key: "rangeToNative",
            value: function(p) {
              var h = this, d = p.collapsed ? [p.index] : [p.index, p.index + p.length], E = [], T = this.scroll.length();
              return d.forEach(function(q, D) {
                q = Math.min(T - 1, q);
                var C = void 0, Z = h.scroll.leaf(q), I = P(Z, 2), R = I[0], O = I[1], S = R.position(O, D !== 0), L = P(S, 2);
            ...
            value: function(p) {
              ...
              if (h != null) {
                ...
                if (d != null) {
                  var E = this.scroll.length() - 1, T = this.scroll.line(Math.min(h.index, E)), q = P(T, 1), D = q[0], C = D;
                  if (h.length > 0) {
                    var Z = this.scroll.line(Math.min(h.index + h.length, E)), I = P(Z, 1);
                    C = I[0];
                  }
                  if (!(D == null || C == null)) {
                    var R = p.getBoundingClientRect();
                    d.top < R.top ? p.scrollTop -= R.top - d.top : d.bottom > R.bottom && (p.scrollTop += d.bottom - R.bottom);
                  }
                }
              }
            }
            ...
            key: "setNativeRange",
            value: function(p, h) {
              var d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : p, E = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : h, T = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !1;
              if (n.info("setNativeRange", p, h, d, E), !(p != null && (this.root.parentNode == null || p.parentNode == null || d.parentNode == null))) {
                var q = document.getSelection();
                if (q != null)
                  if (p != null) {
                    this.hasFocus() || this.root.focus();
                    var D = (this.getNativeRange() || {}).native;
                    if (D == null || T || p !== D.startContainer || h !== D.startOffset || d !== D.endContainer || E !== D.endOffset) {
                      p.tagName == "BR" && (h = [].indexOf.call(p.parentNode.childNodes, p), p = p.parentNode), d.tagName == "BR" && (E = [].indexOf.call(d.parentNode.childNodes, d), d = d.parentNode);
                      var C = document.createRange();
                      C.setStart(p, h), C.setEnd(d, E), q.removeAllRanges(), q.addRange(C);
                    }
                  } else
            ...
            key: "setRange",
            value: function(p) {
              var h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : u.default.sources.API;
              if (typeof h == "string" && (d = h, h = !1), n.info("setRange", p), p != null) {
                var E = this.rangeToNative(p);
            ...
            key: "update",
            value: function() {
              var p = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : u.default.sources.USER, h = this.lastRange, d = this.getRange(), E = P(d, 2), T = E[0], q = E[1];
              if (this.lastRange = T, this.lastRange != null && (this.savedRange = this.lastRange), !(0, t.default)(h, this.lastRange)) {
                ...
                var C = [u.default.events.SELECTION_CHANGE, (0, c.default)(this.lastRange), (0, c.default)(h), p];
                if ((D = this.emitter).emit.apply(D, [u.default.events.EDITOR_CHANGE].concat(C)), p !== u.default.sources.SILENT) {
                  var Z;
      ...
      function(B, _, v) {
        ...
        var e = function(u) {
          ...
          return P(l, [{
            key: "insertInto",
            value: function(r, i) {
              r.children.length === 0 ? N(l.prototype.__proto__ || Object.getPrototypeOf(l.prototype), "insertInto", this).call(this, r, i) : this.remove();
            }
          }, {
            key: "length",
            value: function() {
      ...
      function(B, _, v) {
        ...
        Object.defineProperty(_, "__esModule", { value: !0 });
        var N = v(44), k = v(30), m = v(1), y = function(o) {
          P(t, o);
          function t(e) {
          ...
          return t.prototype.appendChild = function(e) {
            ...
            var e = this;
            this.children = new N.default(), [].slice.call(this.domNode.childNodes).reverse().forEach(function(u) {
              try {
                var l = c(u);
                e.insertBefore(l, e.children.head || void 0);
              } catch (a) {
                if (a instanceof m.ParchmentError)
                  return;
                throw a;
              }
            });
            ...
            if (this.statics.allowedChildren != null && !this.statics.allowedChildren.some(function(l) {
              ...
              throw new m.ParchmentError("Cannot insert " + e.statics.blotName + " into " + this.statics.blotName);
            e.insertInto(this, u);
        ...
        function c(o) {
          ...
          if (t == null)
            try {
              ...
              t = m.create(m.Scope.INLINE), [].slice.call(o.childNodes).forEach(function(u) {
      ...
      function(B, _, v) {
        ...
        Object.defineProperty(_, "__esModule", { value: !0 });
        var N = v(12), k = v(31), m = v(17), y = v(1), c = function(o) {
          P(t, o);
          function t(e) {
            var u = o.call(this, e) || this;
            return u.attributes = new k.default(u.domNode), u;
          }
          return t.formats = function(e) {
            ...
            var l = y.query(e);
            l instanceof N.default ? this.attributes.attribute(l, u) : u && l != null && (e !== this.statics.blotName || this.formats()[e] !== u) && this.replaceWith(e, u);
      ...
      function(B, _, v) {
        ...
        m.prototype.hasNext = function() {
          ...
          if (c) {
            var o = this.offset, t = k.length(c);
      ...
      function(B, _) {
          ...
          function y(l, a, r, i, f) {
            ...
            function g(b, w) {
              ...
              if (P(b, N))
                ...
                p = new RegExp(b.source, u(b)), b.lastIndex && (p.lastIndex = b.lastIndex);
              else if (y.__isDate(b))
                p = new Date(b.getTime());
              else {
                if (A && Buffer.isBuffer(b))
                  return Buffer.allocUnsafe ? p = Buffer.allocUnsafe(b.length) : p = new Buffer(b.length), b.copy(p), p;
                P(b, Error) ? p = Object.create(b) : typeof i > "u" ? (h = Object.getPrototypeOf(b), p = Object.create(h)) : (p = Object.create(i), h = i);
              }
              if (a) {
                var d = n.indexOf(b);
                if (d != -1)
              ...
              P(b, N) && b.forEach(function(R, O) {
                var S = g(O, w - 1), L = g(R, w - 1);
                p.set(S, L);
              }), P(b, k) && b.forEach(function(R) {
                var O = g(R, w - 1);
                p.add(O);
              });
              for (var E in b) {
                var T;
                h && (T = Object.getOwnPropertyDescriptor(h, E)), !(T && T.set == null) && (p[E] = g(b[E], w - 1));
              }
              if (Object.getOwnPropertySymbols)
                for (var q = Object.getOwnPropertySymbols(b), E = 0; E < q.length; E++) {
                  var D = q[E], C = Object.getOwnPropertyDescriptor(b, D);
                  C && !C.enumerable && !f || (p[D] = g(b[D], w - 1), C.enumerable || Object.defineProperty(p, D, {
                    enumerable: !1
                  }));
                }
              if (f)
                for (var Z = Object.getOwnPropertyNames(b), E = 0; E < Z.length; E++) {
                  var I = Z[E], C = Object.getOwnPropertyDescriptor(b, I);
                  C && C.enumerable || (p[I] = g(b[I], w - 1), Object.defineProperty(p, I, {
                    enumerable: !1
                  }));
                }
              return p;
        ...
        typeof B == "object" && B.exports && (B.exports = v);
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
        ...
        var P = function() {
          function p(h, d) {
            var E = [], T = !0, q = !1, D = void 0;
            try {
              for (var C = h[Symbol.iterator](), Z; !(T = (Z = C.next()).done) && (E.push(Z.value), !(d && E.length === d)); T = !0)
                ;
            } catch (I) {
              q = !0, D = I;
            } finally {
          ...
          return function(h, d, E) {
            return d && p(h.prototype, d), E && p(h, E), h;
          };
        }(), k = function p(h, d, E) {
        ...
        }, m = v(0), y = n(m), c = v(8), o = n(c), t = v(4), e = n(t), u = v(16), l = n(u), a = v(13), r = n(a), i = v(25), f = n(i);
        function n(p) {
        ...
        function b(p) {
          return p instanceof e.default || p instanceof t.BlockEmbed;
        }
        var w = function(p) {
          g(h, p);
          function h(d, E) {
            s(this, h);
            var T = A(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, d));
            return T.emitter = E.emitter, Array.isArray(E.whitelist) && (T.whitelist = E.whitelist.reduce(function(q, D) {
              return q[D] = !0, q;
          ...
          return N(h, [{
            ...
            key: "deleteAt",
            value: function(E, T) {
              var q = this.line(E), D = P(q, 2), C = D[0], Z = D[1], I = this.line(E + T), R = P(I, 1), O = R[0];
              if (k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "deleteAt", this).call(this, E, T), O != null && C !== O && Z > 0) {
            ...
            value: function(E, T, q, D) {
              this.whitelist != null && !this.whitelist[q] || (k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "formatAt", this).call(this, E, T, q, D), this.optimize());
            }
          }, {
            key: "insertAt",
...
`) && (T = T.slice(0, -1)), D.insertAt(0, T, q);
                  ...
                  k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "insertAt", this).call(this, E, T, q);
                this.optimize();
              }
            }
          }, {
            ...
            value: function(E, T) {
              ...
              k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "insertBefore", this).call(this, E, T);
            }
          }, {
            key: "leaf",
            value: function(E) {
            ...
            key: "line",
            value: function(E) {
              return E === this.length() ? this.line(E - 1) : this.descendant(b, E);
            }
          }, {
            key: "lines",
            value: function() {
              var E = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, T = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Number.MAX_VALUE, q = function D(C, Z, I) {
                var R = [], O = I;
                return C.children.forEachAt(Z, I, function(S, L, F) {
            ...
            value: function() {
              ...
              this.batch !== !0 && (k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "optimize", this).call(this, E, T), E.length > 0 && this.emitter.emit(o.default.events.SCROLL_OPTIMIZE, E, T));
            }
          }, {
            key: "path",
            value: function(E) {
              return k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "path", this).call(this, E).slice(1);
            }
          }, {
            key: "update",
            value: function(E) {
              if (this.batch !== !0) {
                ...
                typeof E == "string" && (T = E), Array.isArray(E) || (E = this.observer.takeRecords()), E.length > 0 && this.emitter.emit(o.default.events.SCROLL_BEFORE_UPDATE, T, E), k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "update", this).call(this, E.concat([])), E.length > 0 && this.emitter.emit(o.default.events.SCROLL_UPDATE, T, E);
              }
            }
          }]), h;
        }(y.default.Scroll);
        w.blotName = "scroll", w.className = "ql-editor", w.tagName = "DIV", w.defaultChild = "block", w.allowedChildren = [e.default, t.BlockEmbed, f.default], _.default = w;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
        ...
        }(), m = v(21), y = p(m), c = v(11), o = p(c), t = v(3), e = p(t), u = v(2), l = p(u), a = v(20), r = p(a), i = v(0), f = p(i), n = v(5), s = p(n), A = v(10), g = p(A), b = v(9), w = p(b);
        function p(x) {
        ...
        var q = (0, g.default)("quill:keyboard"), D = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey", C = function(x) {
          T(j, x), k(j, null, [{
            key: "match",
            value: function(H, V) {
              return V = M(V), ["altKey", "ctrlKey", "metaKey", "shiftKey"].some(function(Y) {
          ...
          function j(U, H) {
            d(this, j);
            var V = E(this, (j.__proto__ || Object.getPrototypeOf(j)).call(this, U, H));
            ...
            }), /Firefox/i.test(navigator.userAgent) ? (V.addBinding({ key: j.keys.BACKSPACE }, { collapsed: !0 }, I), V.addBinding({ key: j.keys.DELETE }, { collapsed: !0 }, R)) : (V.addBinding({ key: j.keys.BACKSPACE }, { collapsed: !0, prefix: /^.?$/ }, I), V.addBinding({ key: j.keys.DELETE }, { collapsed: !0, suffix: /^.?$/ }, R)), V.addBinding({ key: j.keys.BACKSPACE }, { collapsed: !1 }, O), V.addBinding({ key: j.keys.DELETE }, { collapsed: !1 }, O), V.addBinding({ key: j.keys.BACKSPACE, altKey: null, ctrlKey: null, metaKey: null, shiftKey: null }, { collapsed: !0, offset: 0 }, I), V.listen(), V;
          }
          return k(j, [{
            key: "addBinding",
            value: function(H) {
              var V = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, Y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, X = M(H);
                ...
                if (!V.defaultPrevented) {
                  ...
                  if (X.length !== 0) {
                    ...
                    if (!(Q == null || !H.quill.hasFocus())) {
                      var nt = H.quill.getLine(Q.index), rt = N(nt, 2), at = rt[0], lt = rt[1], z = H.quill.getLeaf(Q.index), K = N(z, 2), $ = K[0], G = K[1], W = Q.length === 0 ? [$, G] : H.quill.getLeaf(Q.index + Q.length), J = N(W, 2), tt = J[0], et = J[1], ut = $ instanceof f.default.Text ? $.value().slice(0, G) : "", ft = tt instanceof f.default.Text ? tt.value().slice(et) : "", it = {
                        ...
                        if (Array.isArray(ot.format)) {
                          if (ot.format.every(function(st) {
                            return it.format[st] == null;
                          }))
                            return !1;
                        } else if (P(ot.format) === "object" && !Object.keys(ot.format).every(function(st) {
                          return ot.format[st] === !0 ? it.format[st] != null : ot.format[st] === !1 ? it.format[st] == null : (0, o.default)(ot.format[st], it.format[st]);
                        }))
                          return !1;
        ...
        C.keys = {
          ...
          bindings: {
            ...
            "checklist enter": {
              ...
              format: { list: "checked" },
              handler: function(j) {
                var U = this.quill.getLine(j.index), H = N(U, 2), V = H[0], Y = H[1], X = (0, e.default)({}, V.formats(), { list: "checked" }), Q = new l.default().retain(j.index).insert(`
`, X).retain(V.length() - Y - 1).retain(1, { list: "unchecked" });
            ...
            "header enter": {
              ...
              suffix: /^$/,
              handler: function(j, U) {
                var H = this.quill.getLine(j.index), V = N(H, 2), Y = V[0], X = V[1], Q = new l.default().retain(j.index).insert(`
`, U.format).retain(Y.length() - X - 1).retain(1, { header: null });
            ...
            "list autofill": {
              ...
              prefix: /^\s*?(\d+\.|-|\*|\[ ?\]|\[x\])$/,
              handler: function(j, U) {
                var H = U.prefix.length, V = this.quill.getLine(j.index), Y = N(V, 2), X = Y[0], Q = Y[1];
                if (Q > H)
                  return !0;
                var nt = void 0;
            ...
            "code exit": {
              ...
              suffix: /^\s+$/,
              handler: function(j) {
                var U = this.quill.getLine(j.index), H = N(U, 2), V = H[0], Y = H[1], X = new l.default().retain(j.index + V.length() - Y - 2).retain(1, { "code-block": null }).delete(1);
        ...
        function Z(x, j) {
          ...
          return U = {
            ...
            var Q = this.quill.getLeaf(X), nt = N(Q, 1), rt = nt[0];
        ...
        function I(x, j) {
          if (!(x.index === 0 || this.quill.getLength() <= 1)) {
            var U = this.quill.getLine(x.index), H = N(U, 1), V = H[0], Y = {};
            if (j.offset === 0) {
              var X = this.quill.getLine(x.index - 1), Q = N(X, 1), nt = Q[0];
        ...
        function R(x, j) {
          ...
          if (!(x.index >= this.quill.getLength() - U)) {
            var H = {}, V = 0, Y = this.quill.getLine(x.index), X = N(Y, 1), Q = X[0];
            if (j.offset >= Q.length() - 1) {
              var nt = this.quill.getLine(x.index + 1), rt = N(nt, 1), at = rt[0];
              if (at) {
...
`, H, s.default.sources.USER), this.quill.setSelection(x.index + 1, s.default.sources.SILENT), this.quill.focus(), Object.keys(j.format).forEach(function(V) {
        ...
        function L(x) {
          return {
            ...
            format: { "code-block": !0 },
            handler: function(U) {
              var H = f.default.query("code-block"), V = U.index, Y = U.length, X = this.quill.scroll.descendant(H, V), Q = N(X, 2), nt = Q[0], rt = Q[1];
              if (nt != null) {
...
`);
      ...
      function(B, _, v) {
        ...
        var P = function() {
          function r(i, f) {
            var n = [], s = !0, A = !1, g = void 0;
            try {
              for (var b = i[Symbol.iterator](), w; !(s = (w = b.next()).done) && (n.push(w.value), !(f && n.length === f)); s = !0)
                ;
            } catch (p) {
              A = !0, g = p;
            } finally {
        ...
        var a = function(r) {
          ...
          return k(i, [{
            ...
            value: function(n, s) {
              if (this._length !== 0)
                return N(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "format", this).call(this, n, s);
              for (var A = this, g = 0; A != null && A.statics.scope !== y.default.Scope.BLOCK_BLOT; )
                g += A.offset(A.parent), A = A.parent;
              A != null && (this._length = i.CONTENTS.length, A.optimize(), A.formatAt(g, i.CONTENTS.length, n, s), this._length = 0);
            }
          }, {
            key: "index",
            value: function(n, s) {
              return n === this.textNode ? 0 : N(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "index", this).call(this, n, s);
            }
          }, {
            key: "length",
            value: function() {
            ...
            key: "remove",
            value: function() {
              N(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "remove", this).call(this), this.parent = null;
            }
          }, {
            key: "restore",
            value: function() {
              if (!(this.selection.composing || this.parent == null)) {
                ...
                if (this.textNode.data !== i.CONTENTS) {
                  var p = this.textNode.data.split(i.CONTENTS).join("");
                  this.next instanceof o.default ? (A = this.next.domNode, this.next.insertAt(0, p), this.textNode.data = i.CONTENTS) : (this.textNode.data = p, this.parent.insertBefore(y.default.create(this.textNode), this), this.textNode = document.createTextNode(i.CONTENTS), this.domNode.appendChild(this.textNode));
                }
                if (this.remove(), g != null) {
                  var h = [g, b].map(function(E) {
                    return Math.max(0, Math.min(A.data.length, E - 1));
                  }), d = P(h, 2);
                  return g = d[0], b = d[1], {
                    startNode: A,
                    startOffset: g,
      ...
      function(B, _, v) {
        ...
        e.allowedChildren = [m.default, k.BlockEmbed, e], _.default = e;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
        ...
        var e = function(a) {
          ...
          return P(r, [{
            key: "value",
            value: function(f) {
              var n = N(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "value", this).call(this, f);
              return n.startsWith("rgb(") ? (n = n.replace(/^[^\d]+/, "").replace(/[^\d]+$/, ""), "#" + n.split(",").map(function(s) {
                return ("00" + parseInt(s).toString(16)).slice(-2);
              }).join("")) : n;
            }
          }]), r;
        }(m.default.Attributor.Style), u = new m.default.Attributor.Class("color", "ql-color", {
          ...
          return P(a, [{
            ...
            value: function(i, f) {
              if (i !== this.statics.blotName || !f)
                return N(a.prototype.__proto__ || Object.getPrototypeOf(a.prototype), "format", this).call(this, i, f);
              f = this.constructor.sanitize(f), this.domNode.setAttribute("href", f);
            }
          }], [{
            key: "create",
            value: function(i) {
              var f = N(a.__proto__ || Object.getPrototypeOf(a), "create", this).call(this, i);
      ...
      function(B, _, v) {
        ...
        var P = v(0), N = q(P), k = v(5), m = q(k), y = v(4), c = q(y), o = v(16), t = q(o), e = v(25), u = q(e), l = v(24), a = q(l), r = v(35), i = q(r), f = v(6), n = q(f), s = v(22), A = q(s), g = v(7), b = q(g), w = v(55), p = q(w), h = v(42), d = q(h), E = v(23), T = q(E);
        function q(D) {
        ...
        }), N.default.register(c.default, t.default, a.default, n.default, A.default, b.default), _.default = m.default;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", { value: !0 });
        var P = v(1), N = function() {
          ...
          }, k.prototype.deleteAt = function(m, y) {
            var c = this.isolate(m, y);
            c.remove();
          }, k.prototype.formatAt = function(m, y, c, o) {
          ...
          }, k.prototype.insertAt = function(m, y, c) {
            var o = c == null ? P.create("text", y) : P.create(y, c), t = this.split(m);
            this.parent.insertBefore(o, t);
          }, k.prototype.insertInto = function(m, y) {
            y === void 0 && (y = null), this.parent != null && this.parent.children.remove(this);
            var c = null;
            m.children.insertBefore(this, y), y != null && (c = y.domNode), (this.domNode.parentNode != m.domNode || this.domNode.nextSibling != c) && m.domNode.insertBefore(this.domNode, c), this.parent = m, this.attach();
          }, k.prototype.isolate = function(m, y) {
            var c = this.split(m);
            return c.split(y), c;
          }, k.prototype.length = function() {
            return 1;
          }, k.prototype.offset = function(m) {
            return m === void 0 && (m = this.parent), this.parent == null || this == m ? 0 : this.parent.children.offset(this) + this.parent.offset(m);
          }, k.prototype.optimize = function(m) {
            this.domNode[P.DATA_KEY] != null && delete this.domNode[P.DATA_KEY].mutations;
          }, k.prototype.remove = function() {
            this.domNode.parentNode != null && this.domNode.parentNode.removeChild(this.domNode), this.detach();
          }, k.prototype.replace = function(m) {
            m.parent != null && (m.parent.insertBefore(this, m.next), m.remove());
          }, k.prototype.replaceWith = function(m, y) {
            var c = typeof m == "string" ? P.create(m, y) : m;
            return c.replace(this), c;
          }, k.prototype.split = function(m, y) {
            return m === 0 ? this : this.next;
          }, k.prototype.update = function(m, y) {
          }, k.prototype.wrap = function(m, y) {
            var c = typeof m == "string" ? P.create(m, y) : m;
            return this.parent != null && this.parent.insertBefore(c, this.next), c.appendChild(this), c;
          }, k.blotName = "abstract", k;
        }();
        _.default = N;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", { value: !0 });
        var P = v(12), N = v(32), k = v(33), m = v(1), y = function() {
          function c(o) {
          ...
          return c.prototype.attribute = function(o, t) {
            ...
            var o = this;
            this.attributes = {};
            var t = P.default.keys(this.domNode), e = N.default.keys(this.domNode), u = k.default.keys(this.domNode);
      ...
      function(B, _, v) {
        ...
        var m = function(y) {
          ...
          return c.keys = function(o) {
            ...
            return this.canAdd(o, t) ? (o.style[k(this.keyName)] = t, !0) : !1;
          }, c.prototype.remove = function(o) {
            o.style[k(this.keyName)] = "", o.getAttribute("style") || o.removeAttribute("style");
          }, c.prototype.value = function(o) {
            var t = o.style[k(this.keyName)];
      ...
      function(B, _, v) {
        ...
        var k = function() {
          function m(y, c) {
            N(this, m), this.quill = y, this.options = c, this.modules = {};
          }
          return P(m, [{
            key: "init",
            value: function() {
      ...
      function(B, _, v) {
        ...
        var l = "\uFEFF", a = function(r) {
          ...
          return P(i, [{
            key: "index",
            value: function(n, s) {
              return n === this.leftGuard ? 0 : n === this.rightGuard ? 1 : N(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "index", this).call(this, n, s);
            }
          }, {
            key: "restore",
            value: function(n) {
              ...
              if (n === this.leftGuard)
                if (this.prev instanceof c.default) {
                  ...
                  A = document.createTextNode(g), this.parent.insertBefore(m.default.create(A), this), s = {
                    startNode: A,
                ...
                n === this.rightGuard && (this.next instanceof c.default ? (this.next.insertAt(0, g), s = {
                  ...
                  startOffset: g.length
                }) : (A = document.createTextNode(g), this.parent.insertBefore(m.default.create(A), this.next), s = {
                  startNode: A,
                  startOffset: g.length
                }));
              return n.data = l, s;
      ...
      function(B, _, v) {
        ...
        }, y = new N.default.Attributor.Attribute("align", "align", m), c = new N.default.Attributor.Class("align", "ql-align", m), o = new N.default.Attributor.Style("align", "text-align", m);
      ...
      function(B, _, v) {
        ...
        var m = {
          scope: N.default.Scope.BLOCK,
          whitelist: ["rtl"]
        }, y = new N.default.Attributor.Attribute("direction", "dir", m), c = new N.default.Attributor.Class("direction", "ql-direction", m), o = new N.default.Attributor.Style("direction", "direction", m);
      ...
      function(B, _, v) {
        ...
        var e = {
        ...
        }, u = new m.default.Attributor.Class("font", "ql-font", e), l = function(r) {
          t(i, r);
          function i() {
          ...
          return P(i, [{
            key: "value",
            value: function(n) {
              return N(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "value", this).call(this, n).replace(/["']/g, "");
            }
          }]), i;
        }(m.default.Attributor.Style), a = new l("font", "font-family", e);
      ...
      function(B, _, v) {
        ...
        }(), N = v(0), k = t(N), m = v(5), y = t(m), c = v(9), o = t(c);
        function t(f) {
        ...
        var a = function(f) {
          ...
          function n(s, A) {
            ...
            return g.lastRecorded = 0, g.ignoreChange = !1, g.clear(), g.quill.on(y.default.events.EDITOR_CHANGE, function(b, w, p, h) {
              b !== y.default.events.TEXT_CHANGE || g.ignoreChange || (!g.options.userOnly || h === y.default.sources.USER ? g.record(w, p) : g.transform(w));
          ...
          return P(n, [{
            ...
            value: function(A, g) {
              if (this.stack[A].length !== 0) {
                ...
                this.stack[g].push(b), this.lastRecorded = 0, this.ignoreChange = !0, this.quill.updateContents(b[A], y.default.sources.USER), this.ignoreChange = !1;
                var w = i(b[A]);
            ...
            value: function(A, g) {
              if (A.ops.length !== 0) {
                this.stack.redo = [];
                var b = this.quill.getContents().diff(g), w = Date.now();
                if (this.lastRecorded + this.options.delay > w && this.stack.undo.length > 0) {
                  var p = this.stack.undo.pop();
                  b = b.compose(p.undo), A = p.redo.compose(A);
                } else
                  this.lastRecorded = w;
            ...
            value: function(A) {
              this.stack.undo.forEach(function(g) {
                g.undo = A.transform(g.undo, !0), g.redo = A.transform(g.redo, !0);
...
`) : n.attributes != null ? Object.keys(n.attributes).some(function(s) {
            return k.default.query(s, k.default.Scope.BLOCK) != null;
          }) : !1;
        }
        function i(f) {
      ...
      function(B, _, v) {
        ...
        }, k = v(3), m = w(k), y = v(2), c = w(y), o = v(8), t = w(o), e = v(23), u = w(e), l = v(34), a = w(l), r = v(59), i = w(r), f = v(60), n = w(f), s = v(28), A = w(s), g = v(61), b = w(g);
        function w(S) {
        ...
        var E = [!1, "center", "right", "justify"], T = ["#000000", "#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc", "#9933ff", "#ffffff", "#facccc", "#ffebcc", "#ffffcc", "#cce8cc", "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266", "#ffff66", "#66b966", "#66a3e0", "#c285ff", "#888888", "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2", "#6b24b2", "#444444", "#5c0000", "#663d00", "#666600", "#003700", "#002966", "#3d1466"], q = [!1, "serif", "monospace"], D = ["1", "2", "3", !1], C = ["small", !1, "large", "huge"], Z = function(S) {
          ...
          function L(F, M) {
            p(this, L);
            var x = h(this, (L.__proto__ || Object.getPrototypeOf(L)).call(this, F, M)), j = function U(H) {
          ...
          return P(L, [{
            key: "addModule",
            value: function(M) {
              var x = N(L.prototype.__proto__ || Object.getPrototypeOf(L.prototype), "addModule", this).call(this, M);
            ...
            value: function(M, x) {
              ...
              this.pickers = M.map(function(H) {
                ...
                if (H.classList.contains("ql-background") || H.classList.contains("ql-color")) {
                  ...
                  return H.querySelector("option") == null && (H.classList.contains("ql-font") ? O(H, q) : H.classList.contains("ql-header") ? O(H, D) : H.classList.contains("ql-size") && O(H, C)), new A.default(H);
              });
              var U = function() {
        ...
        var I = function(S) {
          ...
          function L(F, M) {
            p(this, L);
            var x = h(this, (L.__proto__ || Object.getPrototypeOf(L)).call(this, F, M));
          ...
          return P(L, [{
            ...
            value: function() {
              ...
              this.textbox.addEventListener("keydown", function(x) {
                u.default.match(x, "enter") ? (M.save(), x.preventDefault()) : u.default.match(x, "escape") && (M.cancel(), x.preventDefault());
              });
            }
          }, {
            key: "cancel",
            ...
            key: "edit",
            value: function() {
              var M = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "link", x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
            ...
            value: function() {
              ...
              this.quill.focus(), this.quill.scrollingContainer.scrollTop = M;
            }
          }, {
            key: "save",
            value: function() {
              ...
              switch (this.root.getAttribute("data-mode")) {
                case "link": {
                  ...
                  this.linkRange ? (this.quill.formatText(this.linkRange, "link", M, t.default.sources.USER), delete this.linkRange) : (this.restoreFocus(), this.quill.format("link", M, t.default.sources.USER)), this.quill.root.scrollTop = x;
                  break;
                }
                case "video":
                  M = R(M);
                case "formula": {
                  ...
                  if (j != null) {
                    ...
                    this.quill.insertEmbed(U, this.root.getAttribute("data-mode"), M, t.default.sources.USER), this.root.getAttribute("data-mode") === "formula" && this.quill.insertText(U + 1, " ", t.default.sources.USER), this.quill.setSelection(U + 2, t.default.sources.USER);
                  }
                  break;
                }
              }
        ...
        function O(S, L) {
          ...
          L.forEach(function(M) {
            ...
            M === F ? x.setAttribute("selected", "selected") : x.setAttribute("value", M), S.appendChild(x);
          });
        }
      ...
      function(B, _, v) {
        ...
        var P = function() {
          ...
          return N.prototype.append = function() {
            for (var k = [], m = 0; m < arguments.length; m++)
              k[m] = arguments[m];
            this.insertBefore(k[0], null), k.length > 1 && this.append.apply(this, k.slice(1));
          }, N.prototype.contains = function(k) {
            for (var m, y = this.iterator(); m = y(); )
              if (m === k)
                return !0;
            return !1;
          }, N.prototype.insertBefore = function(k, m) {
            !k || (k.next = m, m != null ? (k.prev = m.prev, m.prev != null && (m.prev.next = k), m.prev = k, m === this.head && (this.head = k)) : this.tail != null ? (this.tail.next = k, k.prev = this.tail, this.tail = k) : (k.prev = null, this.head = this.tail = k), this.length += 1);
          }, N.prototype.offset = function(k) {
            ...
            return -1;
          }, N.prototype.remove = function(k) {
            !this.contains(k) || (k.prev != null && (k.prev.next = k.next), k.next != null && (k.next.prev = k.prev), k === this.head && (this.head = k.next), k === this.tail && (this.tail = k.prev), this.length -= 1);
          }, N.prototype.iterator = function(k) {
            return k === void 0 && (k = this.head), function() {
              var m = k;
              return k != null && (k = k.next), m;
            };
          }, N.prototype.find = function(k, m) {
            m === void 0 && (m = !1);
            for (var y, c = this.iterator(); y = c(); ) {
              var o = y.length();
              if (k < o || m && k === o && (y.next == null || y.next.length() !== 0))
                return [y, k];
              k -= o;
            }
            return [null, 0];
          }, N.prototype.forEach = function(k) {
            for (var m, y = this.iterator(); m = y(); )
              k(m);
          }, N.prototype.forEachAt = function(k, m, y) {
            if (!(m <= 0))
              for (var c = this.find(k), o = c[0], t = c[1], e, u = k - t, l = this.iterator(o); (e = l()) && u < k + m; ) {
                var a = e.length();
                k > u ? y(e, k - u, Math.min(m, u + a - k)) : y(e, 0, Math.min(a, k + m - u)), u += a;
              }
          }, N.prototype.map = function(k) {
            return this.reduce(function(m, y) {
              return m.push(k(y)), m;
            }, []);
          }, N.prototype.reduce = function(k, m) {
            for (var y, c = this.iterator(); y = c(); )
              m = k(m, y);
            return m;
          }, N;
        ...
        var N = v(17), k = v(1), m = {
          ...
          function t(e) {
            ...
            return u.scroll = u, u.observer = new MutationObserver(function(l) {
              u.update(l);
            }), u.observer.observe(u.domNode, m), u.attach(), u;
          }
          return t.prototype.detach = function() {
            ...
            for (var r = function(s, A) {
              A === void 0 && (A = !0), !(s == null || s === l) && s.domNode.parentNode != null && (s.domNode[k.DATA_KEY].mutations == null && (s.domNode[k.DATA_KEY].mutations = []), A && r(s.parent));
            }, i = function(s) {
              s.domNode[k.DATA_KEY] == null || s.domNode[k.DATA_KEY].mutations == null || (s instanceof N.default && s.children.forEach(i), s.optimize(u));
            }, f = e, n = 0; f.length > 0; n += 1) {
              if (n >= y)
                throw new Error("[Parchment] Maximum optimize iterations reached");
              for (f.forEach(function(s) {
                var A = k.find(s.target, !0);
                A != null && (A.domNode === s.target && (s.type === "childList" ? (r(k.find(s.previousSibling, !1)), [].forEach.call(s.addedNodes, function(g) {
                  var b = k.find(g, !1);
                  r(b, !1), b instanceof N.default && b.children.forEach(function(w) {
                    r(w, !1);
                  });
            ...
            u === void 0 && (u = {}), e = e || this.observer.takeRecords(), e.map(function(a) {
              var r = k.find(a.target, !0);
              return r == null ? null : r.domNode[k.DATA_KEY].mutations == null ? (r.domNode[k.DATA_KEY].mutations = [a], r) : (r.domNode[k.DATA_KEY].mutations.push(a), null);
            }).forEach(function(a) {
              a == null || a === l || a.domNode[k.DATA_KEY] == null || a.update(a.domNode[k.DATA_KEY].mutations || [], u);
            }), this.domNode[k.DATA_KEY].mutations != null && o.prototype.update.call(this, this.domNode[k.DATA_KEY].mutations, u), this.optimize(e, u);
          }, t.blotName = "scroll", t.defaultChild = "block", t.scope = k.Scope.BLOCK_BLOT, t.tagName = "DIV", t;
        }(N.default);
        _.default = c;
      },
      function(B, _, v) {
        ...
        var y = function(c) {
          ...
          return o.formats = function(t) {
            ...
            t === this.statics.blotName && !e ? (this.children.forEach(function(l) {
              l instanceof N.default || (l = l.wrap(o.blotName, !0)), u.attributes.copy(l);
            }), this.unwrap()) : c.prototype.format.call(this, t, e);
          }, o.prototype.formatAt = function(t, e, u, l) {
            if (this.formats()[u] != null || k.query(u, k.Scope.ATTRIBUTE)) {
            ...
            if (Object.keys(e).length === 0)
              return this.unwrap();
            var u = this.next;
            u instanceof o && u.prev === this && m(e, u.formats()) && (u.moveChildren(this), u.remove());
          }, o.blotName = "inline", o.scope = k.Scope.INLINE_BLOT, o.tagName = "SPAN", o;
        }(N.default);
        _.default = y;
      },
      function(B, _, v) {
        ...
        Object.defineProperty(_, "__esModule", { value: !0 });
        var N = v(18), k = v(1), m = function(y) {
          P(c, y);
          function c() {
            return y !== null && y.apply(this, arguments) || this;
          }
          return c.formats = function(o) {
            var t = k.query(c.blotName).tagName;
            if (o.tagName !== t)
              return y.formats.call(this, o);
          }, c.prototype.format = function(o, t) {
            k.query(o, k.Scope.BLOCK) != null && (o === this.statics.blotName && !t ? this.replaceWith(c.blotName) : y.prototype.format.call(this, o, t));
          }, c.prototype.formatAt = function(o, t, e, u) {
            k.query(e, k.Scope.BLOCK) != null ? this.format(e, u) : y.prototype.formatAt.call(this, o, t, e, u);
          }, c.prototype.insertAt = function(o, t, e) {
            if (e == null || k.query(t, k.Scope.INLINE) != null)
              y.prototype.insertAt.call(this, o, t, e);
            else {
              var u = this.split(o), l = k.create(t, e);
          ...
          }, c.blotName = "block", c.scope = k.Scope.BLOCK_BLOT, c.tagName = "P", c;
        }(N.default);
        _.default = m;
      },
      function(B, _, v) {
        var P = this && this.__extends || function() {
          var m = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(y, c) {
            y.__proto__ = c;
          } || function(y, c) {
            for (var o in c)
        ...
        var N = v(19), k = function(m) {
          ...
          return y.formats = function(c) {
            ...
            c === 0 && o === this.length() ? this.format(t, e) : m.prototype.formatAt.call(this, c, o, t, e);
      ...
      function(B, _, v) {
        ...
        var N = v(19), k = v(1), m = function(y) {
          ...
          return c.create = function(o) {
            ...
            var e = k.create(this.domNode.splitText(o));
            ...
            return this.text;
          }, c.blotName = "text", c.scope = k.Scope.INLINE_BLOT, c;
        }(N.default);
        _.default = m;
      },
      function(B, _, v) {
        ...
        if (P.classList.toggle("test-class", !1), P.classList.contains("test-class")) {
          ...
          DOMTokenList.prototype.toggle = function(k, m) {
            return arguments.length > 1 && !this.contains(k) == !m ? m : N.call(this, k);
          };
        }
        String.prototype.startsWith || (String.prototype.startsWith = function(k, m) {
          return m = m || 0, this.substr(m, k.length) === k;
        }), String.prototype.endsWith || (String.prototype.endsWith = function(k, m) {
          var y = this.toString();
          (typeof m != "number" || !isFinite(m) || Math.floor(m) !== m || m > y.length) && (m = y.length), m -= k.length;
          var c = y.indexOf(k, m);
          return c !== -1 && c === m;
      ...
      function(B, _) {
        ...
        function k(n, s, A) {
          ...
          var p = m(n, s);
          return b && p.unshift([N, b]), w && p.push([N, w]), u(p), A != null && (p = r(p, A)), p = i(p), p;
        }
        function m(n, s) {
          var A;
          if (!n)
          ...
          if (!s)
            return [[v, n]];
          var g = n.length > s.length ? n : s, b = n.length > s.length ? s : n, w = g.indexOf(b);
          if (w != -1)
            return A = [
              [P, g.substring(0, w)],
              [N, b],
              [P, g.substring(w + b.length)]
            ], n.length > s.length && (A[0][0] = A[2][0] = v), A;
          if (b.length == 1)
            return [[v, n], [P, s]];
          var p = e(n, s);
          if (p) {
            var h = p[0], d = p[1], E = p[2], T = p[3], q = p[4], D = k(h, E), C = k(d, T);
            return D.concat([[N, q]], C);
          }
          return y(n, s);
        }
        function y(n, s) {
          for (var A = n.length, g = s.length, b = Math.ceil((A + g) / 2), w = b, p = 2 * b, h = new Array(p), d = new Array(p), E = 0; E < p; E++)
            h[E] = -1, d[E] = -1;
          h[w + 1] = 0, d[w + 1] = 0;
          for (var T = A - g, q = T % 2 != 0, D = 0, C = 0, Z = 0, I = 0, R = 0; R < b; R++) {
            for (var O = -R + D; O <= R - C; O += 2) {
              var S = w + O, L;
              O == -R || O != R && h[S - 1] < h[S + 1] ? L = h[S + 1] : L = h[S - 1] + 1;
              for (var F = L - O; L < A && F < g && n.charAt(L) == s.charAt(F); )
                L++, F++;
              if (h[S] = L, L > A)
                C += 2;
              else if (F > g)
            ...
            for (var j = -R + Z; j <= R - I; j += 2) {
              var M = w + j, x;
              j == -R || j != R && d[M - 1] < d[M + 1] ? x = d[M + 1] : x = d[M - 1] + 1;
              for (var U = x - j; x < A && U < g && n.charAt(A - x - 1) == s.charAt(g - U - 1); )
                x++, U++;
              if (d[M] = x, x > A)
                I += 2;
              else if (U > g)
        ...
        function c(n, s, A, g) {
          var b = n.substring(0, A), w = s.substring(0, g), p = n.substring(A), h = s.substring(g), d = k(b, w), E = k(p, h);
          return d.concat(E);
        }
        function o(n, s) {
          if (!n || !s || n.charAt(0) != s.charAt(0))
            return 0;
          for (var A = 0, g = Math.min(n.length, s.length), b = g, w = 0; A < b; )
            n.substring(w, b) == s.substring(w, b) ? (A = b, w = A) : g = b, b = Math.floor((g - A) / 2 + A);
          return b;
        }
        function t(n, s) {
          if (!n || !s || n.charAt(n.length - 1) != s.charAt(s.length - 1))
            return 0;
          for (var A = 0, g = Math.min(n.length, s.length), b = g, w = 0; A < b; )
            n.substring(n.length - b, n.length - w) == s.substring(s.length - b, s.length - w) ? (A = b, w = A) : g = b, b = Math.floor((g - A) / 2 + A);
          return b;
        }
        function e(n, s) {
          var A = n.length > s.length ? n : s, g = n.length > s.length ? s : n;
          if (A.length < 4 || g.length * 2 < A.length)
            return null;
          function b(C, Z, I) {
            for (var R = C.substring(I, I + Math.floor(C.length / 4)), O = -1, S = "", L, F, M, x; (O = Z.indexOf(R, O + 1)) != -1; ) {
              var j = o(
                C.substring(I),
                Z.substring(O)
              ), U = t(
              ...
              S.length < U + j && (S = Z.substring(O - U, O) + Z.substring(O, O + j), L = C.substring(0, I - U), F = C.substring(I + j), M = Z.substring(0, O - U), x = Z.substring(O + j));
            }
          ...
          if (!w && !p)
            return null;
          p ? w ? h = w[4].length > p[4].length ? w : p : h = p : h = w;
          var d, E, T, q;
          n.length > s.length ? (d = h[0], E = h[1], T = h[2], q = h[3]) : (T = h[0], q = h[1], d = h[2], E = h[3]);
          var D = h[4];
          return [d, E, T, q, D];
        }
        function u(n) {
          n.push([N, ""]);
          for (var s = 0, A = 0, g = 0, b = "", w = "", p; s < n.length; )
            switch (n[s][0]) {
              case P:
                g++, w += n[s][1], s++;
                break;
              case v:
                ...
                break;
              case N:
                A + g > 1 ? (A !== 0 && g !== 0 && (p = o(w, b), p !== 0 && (s - A - g > 0 && n[s - A - g - 1][0] == N ? n[s - A - g - 1][1] += w.substring(0, p) : (n.splice(0, 0, [
                  N,
                  w.substring(0, p)
                ]), s++), w = w.substring(p), b = b.substring(p)), p = t(w, b), p !== 0 && (n[s][1] = w.substring(w.length - p) + n[s][1], w = w.substring(0, w.length - p), b = b.substring(0, b.length - p))), A === 0 ? n.splice(
                  s - g,
                  A + g,
                  [P, w]
                ) : g === 0 ? n.splice(
                  ...
                  [v, b],
                  [P, w]
                ), s = s - A - g + (A ? 1 : 0) + (g ? 1 : 0) + 1) : s !== 0 && n[s - 1][0] == N ? (n[s - 1][1] += n[s][1], n.splice(s, 1)) : s++, g = 0, A = 0, b = "", w = "";
                break;
            }
          n[n.length - 1][1] === "" && n.pop();
          var h = !1;
          for (s = 1; s < n.length - 1; )
            n[s - 1][0] == N && n[s + 1][0] == N && (n[s][1].substring(n[s][1].length - n[s - 1][1].length) == n[s - 1][1] ? (n[s][1] = n[s - 1][1] + n[s][1].substring(0, n[s][1].length - n[s - 1][1].length), n[s + 1][1] = n[s - 1][1] + n[s + 1][1], n.splice(s - 1, 1), h = !0) : n[s][1].substring(0, n[s + 1][1].length) == n[s + 1][1] && (n[s - 1][1] += n[s + 1][1], n[s][1] = n[s][1].substring(n[s + 1][1].length) + n[s + 1][1], n.splice(s + 1, 1), h = !0)), s++;
          h && u(n);
        }
        var l = k;
        l.INSERT = P, l.DELETE = v, l.EQUAL = N, B.exports = l;
        function a(n, s) {
          if (s === 0)
            return [N, n];
          for (var A = 0, g = 0; g < n.length; g++) {
            ...
            if (b[0] === v || b[0] === N) {
              ...
              if (s < w) {
                n = n.slice();
                var p = s - A, h = [b[0], b[1].slice(0, p)], d = [b[0], b[1].slice(p)];
        ...
        function r(n, s) {
          var A = a(n, s), g = A[1], b = A[0], w = g[b], p = g[b + 1];
          if (w == null)
            return n;
          if (w[0] !== N)
            return n;
          if (p != null && w[1] + p[1] === p[1] + w[1])
            return g.splice(b, 2, p, w), f(g, b, 2);
          if (p != null && p[1].indexOf(w[1]) === 0) {
            g.splice(b, 2, [p[0], w[1]], [0, w[1]]);
            var h = p[1].slice(w[1].length);
            return h.length > 0 && g.splice(b + 2, 0, [p[0], h]), f(g, b, 3);
          } else
            return n;
        }
        function i(n) {
          for (var s = !1, A = function(p) {
            return p.charCodeAt(0) >= 56320 && p.charCodeAt(0) <= 57343;
          }, g = function(p) {
            return p.charCodeAt(p.length - 1) >= 55296 && p.charCodeAt(p.length - 1) <= 56319;
          }, b = 2; b < n.length; b += 1)
            n[b - 2][0] === N && g(n[b - 2][1]) && n[b - 1][0] === v && A(n[b - 1][1]) && n[b][0] === P && A(n[b][1]) && (s = !0, n[b - 1][1] = n[b - 2][1].slice(-1) + n[b - 1][1], n[b][1] = n[b - 2][1].slice(-1) + n[b][1], n[b - 2][1] = n[b - 2][1].slice(0, -1));
          if (!s)
            return n;
      ...
      function(B, _) {
        _ = B.exports = typeof Object.keys == "function" ? Object.keys : v, _.shim = v;
        function v(P) {
          var N = [];
          for (var k in P)
            N.push(k);
      ...
      function(B, _) {
        ...
        _ = B.exports = v ? P : N, _.supported = P;
        function P(k) {
          return Object.prototype.toString.call(k) == "[object Arguments]";
        }
        _.unsupported = N;
        function N(k) {
          return k && typeof k == "object" && typeof k.length == "number" && Object.prototype.hasOwnProperty.call(k, "callee") && !Object.prototype.propertyIsEnumerable.call(k, "callee") || !1;
        }
      },
      function(B, _) {
        ...
        Object.create && (N.prototype = /* @__PURE__ */ Object.create(null), new N().__proto__ || (P = !1));
        function k(y, c, o) {
        ...
        m.prototype.eventNames = function() {
          ...
          for (t in o = this._events)
            v.call(o, t) && c.push(P ? t.slice(1) : t);
          ...
          var e = new k(o, t || this), u = P ? P + c : c;
          ...
          var e = new k(o, t || this, !0), u = P ? P + c : c;
          return this._events[u] ? this._events[u].fn ? this._events[u] = [this._events[u], e] : this._events[u].push(e) : (this._events[u] = e, this._eventsCount++), this;
          ...
          if (!this._events[u])
            return this;
          if (!o)
            return --this._eventsCount === 0 ? this._events = new N() : delete this._events[u], this;
          var l = this._events[u];
          if (l.fn)
            l.fn === o && (!e || l.once) && (!t || l.context === t) && (--this._eventsCount === 0 ? this._events = new N() : delete this._events[u]);
          else {
            for (var a = 0, r = [], i = l.length; a < i; a++)
              (l[a].fn !== o || e && !l[a].once || t && l[a].context !== t) && r.push(l[a]);
            r.length ? this._events[u] = r.length === 1 ? r[0] : r : --this._eventsCount === 0 ? this._events = new N() : delete this._events[u];
          }
          return this;
        }, m.prototype.removeAllListeners = function(c) {
          var o;
          return c ? (o = P ? P + c : c, this._events[o] && (--this._eventsCount === 0 ? this._events = new N() : delete this._events[o])) : (this._events = new N(), this._eventsCount = 0), this;
        }, m.prototype.off = m.prototype.removeListener, m.prototype.addListener = m.prototype.on, m.prototype.setMaxListeners = function() {
          return this;
        }, m.prefixed = P, m.EventEmitter = m, typeof B < "u" && (B.exports = m);
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
        ...
        var P = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(z) {
          ...
          function z(K, $) {
            ...
            try {
              for (var et = K[Symbol.iterator](), ut; !(W = (ut = et.next()).done) && (G.push(ut.value), !($ && G.length === $)); W = !0)
                ;
            } catch (ft) {
              J = !0, tt = ft;
            } finally {
        ...
        }(), m = v(3), y = d(m), c = v(2), o = d(c), t = v(0), e = d(t), u = v(5), l = d(u), a = v(10), r = d(a), i = v(9), f = d(i), n = v(36), s = v(37), A = v(13), g = d(A), b = v(26), w = v(38), p = v(39), h = v(40);
        function d(z) {
        ...
        var C = (0, r.default)("quill:clipboard"), Z = "__ql-matcher", I = [[Node.TEXT_NODE, lt], [Node.TEXT_NODE, nt], ["br", Y], [Node.ELEMENT_NODE, nt], [Node.ELEMENT_NODE, V], [Node.ELEMENT_NODE, rt], [Node.ELEMENT_NODE, H], [Node.ELEMENT_NODE, at], ["li", Q], ["b", U.bind(U, "bold")], ["i", U.bind(U, "italic")], ["style", X]], R = [n.AlignAttribute, w.DirectionAttribute].reduce(function(z, K) {
          return z[K.keyName] = K, z;
        }, {}), O = [n.AlignStyle, s.BackgroundStyle, b.ColorStyle, w.DirectionStyle, p.FontStyle, h.SizeStyle].reduce(function(z, K) {
          return z[K.keyName] = K, z;
        }, {}), S = function(z) {
          D(K, z);
          function K($, G) {
            ...
            return W.quill.root.addEventListener("paste", W.onPaste.bind(W)), W.container = W.quill.addContainer("ql-clipboard"), W.container.setAttribute("contenteditable", !0), W.container.setAttribute("tabindex", -1), W.matchers = [], I.concat(W.options.matchers).forEach(function(J) {
              var tt = N(J, 2), et = tt[0], ut = tt[1];
          ...
          return k(K, [{
            ...
            value: function(G) {
              ...
              if (W[g.default.blotName]) {
                ...
                return this.container.innerHTML = "", new o.default().insert(J, E({}, g.default.blotName, W[g.default.blotName]));
              }
              var tt = this.prepareMatching(), et = N(tt, 2), ut = et[0], ft = et[1], it = j(this.container, ut, ft);
              return M(it, `
`) && it.ops[it.ops.length - 1].attributes == null && (it = it.compose(new o.default().retain(it.length() - 1).delete(1))), C.log("convert", this.container.innerHTML, it), this.container.innerHTML = "", it;
        ...
        function L(z, K, $) {
          return (typeof K > "u" ? "undefined" : P(K)) === "object" ? Object.keys(K).reduce(function(G, W) {
            ...
            return W.attributes && W.attributes[K] ? G.push(W) : G.insert(W.insert, (0, y.default)({}, E({}, K, $), W.attributes));
          }, new o.default());
        }
        function F(z) {
...
`), K;
        ...
        function Q(z, K) {
          var $ = e.default.query(z);
          if ($ == null || $.blotName !== "list-item" || !M(K, `
`))
            return K;
...
`), K;
        ...
        function rt(z, K) {
          if (x(z) && z.nextElementSibling != null && !M(K, `
...
`);
      ...
      function(B, _, v) {
        ...
        var e = function(u) {
          ...
          return P(l, [{
            key: "optimize",
            value: function(r) {
              N(l.prototype.__proto__ || Object.getPrototypeOf(l.prototype), "optimize", this).call(this, r), this.domNode.tagName !== this.statics.tagName[0] && this.replaceWith(this.statics.blotName);
            }
          }], [{
            key: "create",
            value: function() {
              return N(l.__proto__ || Object.getPrototypeOf(l), "create", this).call(this);
            }
          }, {
            key: "formats",
            value: function() {
      ...
      function(B, _, v) {
        ...
        var P = function() {
          function h(d, E) {
            ...
            try {
              for (var Z = d[Symbol.iterator](), I; !(q = (I = Z.next()).done) && (T.push(I.value), !(E && T.length === E)); q = !0)
                ;
            } catch (R) {
              D = !0, C = R;
            } finally {
        ...
        }(), k = v(2), m = r(k), y = v(0), c = r(y), o = v(5), t = r(o), e = v(10), u = r(e), l = v(9), a = r(l);
        function r(h) {
          return h && h.__esModule ? h : { default: h };
        }
        function i(h, d, E) {
          return d in h ? Object.defineProperty(h, d, { value: E, enumerable: !0, configurable: !0, writable: !0 }) : h[d] = E, h;
        }
        function f(h, d) {
          if (!(h instanceof d))
            throw new TypeError("Cannot call a class as a function");
        ...
        var A = (0, u.default)("quill:toolbar"), g = function(h) {
          ...
          function d(E, T) {
            f(this, d);
            var q = n(this, (d.__proto__ || Object.getPrototypeOf(d)).call(this, E, T));
            if (Array.isArray(q.options.container)) {
              var D = document.createElement("div");
              w(D, q.options.container), E.container.parentNode.insertBefore(D, E.container), q.container = D;
            } else
            ...
            if (!(q.container instanceof HTMLElement)) {
              var C;
              return C = A.error("Container required for toolbar", q.options), n(q, C);
            }
            return q.container.classList.add("ql-toolbar"), q.controls = [], q.handlers = {}, Object.keys(q.options.handlers).forEach(function(Z) {
              ...
              var Z = q.quill.selection.getRange(), I = P(Z, 1), R = I[0];
              q.update(R);
            }), q;
          }
          return N(d, [{
              ...
              if (!!D) {
                if (D = D.slice(3), T.tagName === "BUTTON" && T.setAttribute("type", "button"), this.handlers[D] == null) {
                  if (this.quill.scroll.whitelist != null && this.quill.scroll.whitelist[D] == null) {
                    A.warn("ignoring attaching to disabled format", D, T);
                    return;
                  }
                  if (c.default.query(D) == null) {
                    A.warn("ignoring attaching to nonexistent format", D, T);
                    return;
                  }
                }
                ...
                T.addEventListener(C, function(Z) {
                  ...
                  if (T.tagName === "SELECT") {
                    ...
                    R.hasAttribute("selected") ? I = !1 : I = R.value || !1;
                  } else
                    T.classList.contains("ql-active") ? I = !1 : I = T.value || !T.hasAttribute("value"), Z.preventDefault();
                  q.quill.focus();
                  var O = q.quill.selection.getRange(), S = P(O, 1), L = S[0];
                  if (q.handlers[D] != null)
                    q.handlers[D].call(q, I);
                  else if (c.default.query(D).prototype instanceof c.default.Embed) {
                    if (I = prompt("Enter " + D), !I)
                      return;
                    q.quill.updateContents(new m.default().retain(L.index).delete(L.length).insert(i({}, D, I)), t.default.sources.USER);
                  } else
                    q.quill.format(D, I, t.default.sources.USER);
                  q.update(L);
              ...
              this.controls.forEach(function(D) {
                ...
                if (I.tagName === "SELECT") {
                  ...
                  if (T == null)
                    ...
                    var O = q[Z];
                    typeof O == "string" && (O = O.replace(/\"/g, '\\"')), R = I.querySelector('option[value="' + O + '"]');
                  }
                  R == null ? (I.value = "", I.selectedIndex = -1) : R.selected = !0;
                } else if (T == null)
                  I.classList.remove("ql-active");
                else if (I.hasAttribute("value")) {
                  var S = q[Z] === I.getAttribute("value") || q[Z] != null && q[Z].toString() === I.getAttribute("value") || q[Z] == null && !I.getAttribute("value");
                  I.classList.toggle("ql-active", S);
                } else
                  I.classList.toggle("ql-active", q[Z] != null);
              });
            }
          }]), d;
        }(a.default);
        ...
        function b(h, d, E) {
          ...
          T.setAttribute("type", "button"), T.classList.add("ql-" + d), E != null && (T.value = E), h.appendChild(T);
        }
        function w(h, d) {
          Array.isArray(d[0]) || (d = [d]), d.forEach(function(E) {
            ...
            T.classList.add("ql-formats"), E.forEach(function(q) {
              if (typeof q == "string")
                ...
                Array.isArray(C) ? p(T, D, C) : b(T, D, C);
              }
            }), h.appendChild(T);
          });
        }
        function p(h, d, E) {
          ...
          T.classList.add("ql-" + d), E.forEach(function(q) {
        ...
        g.DEFAULTS = {
          ...
          handlers: {
            clean: function() {
              var d = this, E = this.quill.getSelection();
              if (E != null)
                if (E.length == 0) {
                  var T = this.quill.getFormat();
                  Object.keys(T).forEach(function(q) {
                    c.default.query(q, c.default.Scope.INLINE) != null && d.quill.format(q, !1);
                  });
                } else
            ...
            direction: function(d) {
              ...
              d === "rtl" && E == null ? this.quill.format("align", "right", t.default.sources.USER) : !d && E === "right" && this.quill.format("align", !1, t.default.sources.USER), this.quill.format("direction", d, t.default.sources.USER);
            },
            indent: function(d) {
            ...
            link: function(d) {
              d === !0 && (d = prompt("Enter link URL:")), this.quill.format("link", d, t.default.sources.USER);
            },
            list: function(d) {
              var E = this.quill.getSelection(), T = this.quill.getFormat(E);
              d === "check" ? T.list === "checked" || T.list === "unchecked" ? this.quill.format("list", !1, t.default.sources.USER) : this.quill.format("list", "unchecked", t.default.sources.USER) : this.quill.format("list", d, t.default.sources.USER);
            }
          }
        }, _.default = g, _.addControls = w;
      },
      function(B, _) {
      ...
      function(B, _, v) {
        ...
        var e = function(u) {
          ...
          return P(l, [{
            key: "buildItem",
            value: function(r) {
              var i = N(l.prototype.__proto__ || Object.getPrototypeOf(l.prototype), "buildItem", this).call(this, r);
              return i.style.backgroundColor = r.getAttribute("value") || "", i;
            }
          }, {
            key: "selectItem",
            value: function(r, i) {
              N(l.prototype.__proto__ || Object.getPrototypeOf(l.prototype), "selectItem", this).call(this, r, i);
      ...
      function(B, _, v) {
        ...
        var e = function(u) {
          ...
          return P(l, [{
            key: "selectItem",
            value: function(r, i) {
              N(l.prototype.__proto__ || Object.getPrototypeOf(l.prototype), "selectItem", this).call(this, r, i), r = r || this.defaultItem, this.label.innerHTML = r.innerHTML;
            }
          }]), l;
        }(m.default);
        _.default = e;
      ...
      function(B, _, v) {
        ...
        var k = function() {
          function m(y, c) {
            var o = this;
            N(this, m), this.quill = y, this.boundsContainer = c || document.body, this.root = y.addContainer("ql-tooltip"), this.root.innerHTML = this.constructor.TEMPLATE, this.quill.root === this.quill.scrollingContainer && this.quill.root.addEventListener("scroll", function() {
      ...
      function(B, _, v) {
        ...
        }(), m = v(3), y = f(m), c = v(8), o = f(c), t = v(43), e = f(t), u = v(27), l = f(u), a = v(15), r = v(41), i = f(r);
        function f(p) {
          return p && p.__esModule ? p : { default: p };
        }
        function n(p, h) {
        ...
        var g = [[{ header: ["1", "2", "3", !1] }], ["bold", "italic", "underline", "link"], [{ list: "ordered" }, { list: "bullet" }], ["clean"]], b = function(p) {
          A(h, p);
          function h(d, E) {
            n(this, h), E.modules.toolbar != null && E.modules.toolbar.container == null && (E.modules.toolbar.container = g);
            var T = s(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, d, E));
        ...
        var w = function(p) {
          ...
          return k(h, [{
            ...
            value: function() {
              var E = this;
              N(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "listen", this).call(this), this.root.querySelector("a.ql-action").addEventListener("click", function(T) {
                ...
                if (T != null) {
                  if (T.length === 0 && D === o.default.sources.USER) {
                    var C = E.quill.scroll.descendant(l.default, T.index), Z = P(C, 2), I = Z[0], R = Z[1];
                    if (I != null) {
            ...
            key: "show",
            value: function() {
              N(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "show", this).call(this), this.root.removeAttribute("data-mode");
            }
          }]), h;
        }(t.BaseTooltip);
        w.TEMPLATE = ['<a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), _.default = b;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
        });
        var P = v(29), N = W(P), k = v(36), m = v(38), y = v(64), c = v(65), o = W(c), t = v(66), e = W(t), u = v(67), l = W(u), a = v(37), r = v(26), i = v(39), f = v(40), n = v(56), s = W(n), A = v(68), g = W(A), b = v(27), w = W(b), p = v(69), h = W(p), d = v(70), E = W(d), T = v(71), q = W(T), D = v(72), C = W(D), Z = v(73), I = W(Z), R = v(13), O = W(R), S = v(74), L = W(S), F = v(75), M = W(F), x = v(57), j = W(x), U = v(41), H = W(U), V = v(28), Y = W(V), X = v(59), Q = W(X), nt = v(60), rt = W(nt), at = v(61), lt = W(at), z = v(108), K = W(z), $ = v(62), G = W($);
        function W(J) {
          return J && J.__esModule ? J : { default: J };
        }
        N.default.register({
          "attributors/attribute/direction": m.DirectionAttribute,
          "attributors/class/align": k.AlignClass,
        ...
        }, !0), N.default.register({
          "formats/align": k.AlignClass,
        ...
        var e = function(l) {
          ...
          return P(a, [{
            ...
            value: function(i, f) {
              ...
              return f === 0 ? (this.remove(i), !0) : N(a.prototype.__proto__ || Object.getPrototypeOf(a.prototype), "add", this).call(this, i, f);
            }
          }, {
            key: "canAdd",
            value: function(i, f) {
              return N(a.prototype.__proto__ || Object.getPrototypeOf(a.prototype), "canAdd", this).call(this, i, f) || N(a.prototype.__proto__ || Object.getPrototypeOf(a.prototype), "canAdd", this).call(this, i, parseInt(f));
            }
          }, {
            key: "value",
            value: function(i) {
              return parseInt(N(a.prototype.__proto__ || Object.getPrototypeOf(a.prototype), "value", this).call(this, i)) || void 0;
            }
          }]), a;
        }(m.default.Attributor.Class), u = new e("indent", "ql-indent", {
      ...
      function(B, _, v) {
        ...
        }, k = v(0), m = e(k), y = v(4), c = e(y), o = v(25), t = e(o);
        function e(n) {
          return n && n.__esModule ? n : { default: n };
        }
        function u(n, s, A) {
          return s in n ? Object.defineProperty(n, s, { value: A, enumerable: !0, configurable: !0, writable: !0 }) : n[s] = A, n;
        }
        function l(n, s) {
          if (!(n instanceof s))
            throw new TypeError("Cannot call a class as a function");
        ...
        var i = function(n) {
          ...
          return P(s, [{
            key: "format",
            value: function(g, b) {
              g === f.blotName && !b ? this.replaceWith(m.default.create(this.statics.scope)) : N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "format", this).call(this, g, b);
            }
          }, {
            key: "remove",
            value: function() {
              this.prev == null && this.next == null ? this.parent.remove() : N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "remove", this).call(this);
            }
          }, {
            key: "replaceWith",
            value: function(g, b) {
              return this.parent.isolate(this.offset(this.parent), this.length()), g === this.parent.statics.blotName ? (this.parent.replaceWith(g, b), this) : (this.parent.unwrap(), N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "replaceWith", this).call(this, g, b));
            }
          }], [{
            key: "formats",
            value: function(g) {
              return g.tagName === this.tagName ? void 0 : N(s.__proto__ || Object.getPrototypeOf(s), "formats", this).call(this, g);
            }
          }]), s;
        }(c.default);
        ...
        var f = function(n) {
          r(s, n), P(s, null, [{
            key: "create",
            value: function(g) {
              var b = g === "ordered" ? "OL" : "UL", w = N(s.__proto__ || Object.getPrototypeOf(s), "create", this).call(this, b);
              return (g === "checked" || g === "unchecked") && w.setAttribute("data-checked", g === "checked"), w;
            }
          }, {
            key: "formats",
            value: function(g) {
          ...
          function s(A) {
            l(this, s);
            var g = a(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, A)), b = function(p) {
              if (p.target.parentNode === A) {
                var h = g.statics.formats(A), d = m.default.find(p.target);
                h === "checked" ? d.format("list", "unchecked") : h === "unchecked" && d.format("list", "checked");
              }
            };
          ...
          return P(s, [{
            ...
            value: function(g, b) {
              if (g instanceof i)
                N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "insertBefore", this).call(this, g, b);
              else {
                var w = b == null ? this.length() : b.offset(this), p = this.split(w);
                p.parent.insertBefore(g, p);
              }
            }
          }, {
            key: "optimize",
            value: function(g) {
              N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "optimize", this).call(this, g);
              var b = this.next;
            ...
            value: function(g) {
              ...
              N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "replace", this).call(this, g);
            }
          }]), s;
        }(t.default);
        f.blotName = "list", f.scope = m.default.Scope.BLOCK_BLOT, f.tagName = ["OL", "UL"], f.defaultChild = "list-item", f.allowedChildren = [i], _.ListItem = i, _.default = f;
      },
      function(B, _, v) {
        Object.defineProperty(_, "__esModule", {
          value: !0
      ...
      function(B, _, v) {
        ...
        var e = function(u) {
          ...
          return P(l, null, [{
            key: "create",
            value: function(r) {
              return r === "super" ? document.createElement("sup") : r === "sub" ? document.createElement("sub") : N(l.__proto__ || Object.getPrototypeOf(l), "create", this).call(this, r);
            }
          }, {
            key: "formats",
            value: function(r) {
      ...
      function(B, _, v) {
        ...
        var u = ["alt", "height", "width"], l = function(a) {
          ...
          return P(r, [{
            key: "format",
            value: function(f, n) {
              u.indexOf(f) > -1 ? n ? this.domNode.setAttribute(f, n) : this.domNode.removeAttribute(f) : N(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "format", this).call(this, f, n);
            }
          }], [{
            key: "create",
            value: function(f) {
              var n = N(r.__proto__ || Object.getPrototypeOf(r), "create", this).call(this, f);
      ...
      function(B, _, v) {
        ...
        var P = function() {
          ...
          if (g === void 0) {
            ...
            if ("value" in g)
              return g.value;
            var w = g.get;
            return w === void 0 ? void 0 : w.call(A);
          }
        }, k = v(35), m = e(k), y = v(5), c = e(y), o = v(9), t = e(o);
        function e(f) {
          return f && f.__esModule ? f : { default: f };
        }
        function u(f, n) {
        ...
        var r = function(f) {
          ...
          return P(n, null, [{
            key: "create",
            value: function(A) {
              var g = N(n.__proto__ || Object.getPrototypeOf(n), "create", this).call(this, A);
              return typeof A == "string" && (window.katex.render(A, g, {
                throwOnError: !1,
                errorColor: "#f00"
              }), g.setAttribute("data-value", A)), g;
            }
          }, {
            key: "value",
            value: function(A) {
      ...
      function(B, _, v) {
        ...
        var P = function() {
          ...
          return function(g, b, w) {
            return b && A(g.prototype, b), w && A(g, w), g;
          };
        }(), N = function A(g, b, w) {
          g === null && (g = Function.prototype);
          var p = Object.getOwnPropertyDescriptor(g, b);
          if (p === void 0) {
            var h = Object.getPrototypeOf(g);
            return h === null ? void 0 : A(h, b, w);
          } else {
            if ("value" in p)
              return p.value;
            var d = p.get;
        ...
        }, k = v(0), m = l(k), y = v(5), c = l(y), o = v(9), t = l(o), e = v(13), u = l(e);
        function l(A) {
          return A && A.__esModule ? A : { default: A };
        }
        function a(A, g) {
        ...
        var f = function(A) {
          ...
          return P(g, [{
            key: "replaceWith",
            value: function(w) {
              this.domNode.textContent = this.domNode.textContent, this.attach(), N(g.prototype.__proto__ || Object.getPrototypeOf(g.prototype), "replaceWith", this).call(this, w);
            }
          }, {
            key: "highlight",
            value: function(w) {
              var p = this.domNode.textContent;
              this.cachedText !== p && ((p.trim().length > 0 || this.cachedText == null) && (this.domNode.innerHTML = w(p), this.domNode.normalize(), this.attach()), this.cachedText = p);
            }
          }]), g;
        }(u.default);
        ...
        var n = new m.default.Attributor.Class("token", "hljs", {
          ...
          function g(b, w) {
            a(this, g);
            var p = r(this, (g.__proto__ || Object.getPrototypeOf(g)).call(this, b, w));
            if (typeof p.options.highlight != "function")
              throw new Error("Syntax module requires highlight.js. Please include the library on the page before Quill.");
            var h = null;
            return p.quill.on(c.default.events.SCROLL_OPTIMIZE, function() {
          ...
          return P(g, [{
            ...
            value: function() {
              ...
              if (!this.quill.selection.composing) {
                ...
                }), this.quill.update(c.default.sources.SILENT), p != null && this.quill.setSelection(p, c.default.sources.SILENT);
              }
            }
          }]), g;
        }(t.default);
        s.DEFAULTS = {
          ...
          interval: 1e3
        }, _.CodeBlock = f, _.CodeToken = n, _.default = s;
      },
      function(B, _) {
      ...
      function(B, _, v) {
        ...
        var P = function g(b, w, p) {
          ...
          return function(b, w, p) {
            return w && g(b.prototype, w), p && g(b, p), b;
          };
        }(), k = v(3), m = a(k), y = v(8), c = a(y), o = v(43), t = a(o), e = v(15), u = v(41), l = a(u);
        function a(g) {
        ...
        var n = [["bold", "italic", "link"], [{ header: 1 }, { header: 2 }, "blockquote"]], s = function(g) {
          f(b, g);
          function b(w, p) {
            r(this, b), p.modules.toolbar != null && p.modules.toolbar.container == null && (p.modules.toolbar.container = n);
            var h = i(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this, w, p));
            return h.quill.container.classList.add("ql-bubble"), h;
          }
          return N(b, [{
            key: "extendToolbar",
            value: function(p) {
              this.tooltip = new A(this.quill, this.options.bounds), this.tooltip.root.appendChild(p.container), this.buildButtons([].slice.call(p.container.querySelectorAll("button")), l.default), this.buildPickers([].slice.call(p.container.querySelectorAll("select")), l.default);
            }
          }]), b;
        }(t.default);
        ...
        var A = function(g) {
          ...
          function b(w, p) {
            r(this, b);
            var h = i(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this, w, p));
            return h.quill.on(c.default.events.EDITOR_CHANGE, function(d, E, T, q) {
              if (d === c.default.events.SELECTION_CHANGE)
                if (E != null && E.length > 0 && q === c.default.sources.USER) {
                  ...
                  if (D.length === 1)
                    ...
                    var C = D[D.length - 1], Z = h.quill.getIndex(C), I = Math.min(C.length() - 1, E.index + E.length - Z), R = h.quill.getBounds(new e.Range(Z, I));
                    h.position(R);
                  }
                } else
          ...
          return N(b, [{
            ...
            value: function() {
              ...
              P(b.prototype.__proto__ || Object.getPrototypeOf(b.prototype), "listen", this).call(this), this.root.querySelector(".ql-close").addEventListener("click", function() {
                p.root.classList.remove("ql-editing");
              }), this.quill.on(c.default.events.SCROLL_OPTIMIZE, function() {
                setTimeout(function() {
                  if (!p.root.classList.contains("ql-hidden")) {
                    var h = p.quill.getSelection();
                    h != null && p.position(p.quill.getBounds(h));
                  }
                }, 1);
              });
            }
            ...
            key: "position",
            value: function(p) {
              var h = P(b.prototype.__proto__ || Object.getPrototypeOf(b.prototype), "position", this).call(this, p), d = this.root.querySelector(".ql-tooltip-arrow");
              if (d.style.marginLeft = "", h === 0)
                return h;
...
const gt = /* @__PURE__ */ pt(dt.exports), _t = /* @__PURE__ */ mt({
  __proto__: null,
  default: gt
}, [dt.exports]);
export {
