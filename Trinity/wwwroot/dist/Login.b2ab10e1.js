import { r as n, o as S, O as i, f as $e, e as N, J as Me, z as Fe, k as V, t as De, q as _e, Z as X, E as le, P as F, C as Be, y as He, s as Ue, u as Ve, a as Ke, L as qe, c as Je, _ as Ze, j as L, F as ze, b as f, H as Xe, B as We } from "./main.8e9066d4.js";
function D() {
...
var K = {
  ...
  }, e.className), J = N("p-checkbox-box", {
    "p-highlight": u,
...
var q = {
  ...
  var e = q.getProps(t), o = e.promptLabel || V("passwordPrompt"), m = e.weakLabel || V("weak"), v = e.mediumLabel || V("medium"), c = e.strongLabel || V("strong"), p = n.exports.useState(!1), l = j(p, 2), d = l[0], x = l[1], C = n.exports.useState(null), T = j(C, 2), b = T[0], u = T[1], A = n.exports.useState(o), R = j(A, 2), $ = R[0], M = R[1], J = n.exports.useState(!1), _ = j(J, 2), k = _[0], g = _[1], B = n.exports.useState(!1), H = j(B, 2), U = H[0], Z = H[1], y = n.exports.useRef(null), w = n.exports.useRef(null), E = n.exports.useRef(e.inputRef), Y = n.exports.useRef(new RegExp(e.mediumRegex)), G = n.exports.useRef(new RegExp(e.strongRegex)), ie = U ? "text" : "password", ce = De({
    target: y,
    overlay: w,
    ...
    when: d
  }), Q = j(ce, 2), pe = Q[0], fe = Q[1], ee = E.current && E.current.value, z = n.exports.useMemo(function() {
  ...
  n.exports.useImperativeHandle(r, function() {
    ...
    !z && S.hasClass(y.current, "p-inputwrapper-filled") && S.removeClass(y.current, "p-inputwrapper-filled");
  }, [z]), _e(function() {
    X.clear(w.current);
  });
  var Re = function() {
...
const lt = () => {
  const t = Ve(), { errors: r, data: e } = Ke(), [o, m] = n.exports.useState(""), [v, c] = n.exports.useState(!1), { layoutConfig: p } = n.exports.useContext(qe), l = Je(), d = N("surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden", { "p-input-filled": p.inputStyle === "filled" }), { data: x, setData: C, post: T, processing: b } = Ze({
    email: "",
    password: "",
    remember: !1
  });
