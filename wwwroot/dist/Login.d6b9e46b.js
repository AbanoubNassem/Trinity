import { r as n, O as f, a as Ce, D as V, c as L, I as De, l as _, f as Ve, g as Pe, Z as q, P as Z, o as We, m as Ae, L as je, w as $e, x as Me, j as s, q as Fe, H as _e, s as He } from "./main.1b845189.js";
import { T as Ke, I as re, C as Ue, P as Be, O as qe, B as Ze } from "./csstransition.esm.cde0513c.js";
function $() {
...
var H = /* @__PURE__ */ n.exports.memo(/* @__PURE__ */ n.exports.forwardRef(function(e, a) {
  var t = n.exports.useState(!1), i = Ge(t, 2), d = i[0], g = i[1], m = n.exports.useRef(null), o = n.exports.useRef(e.inputRef), c = function(l) {
    if (!e.disabled && !e.readOnly && e.onChange) {
      var T = x(), M = l.target instanceof HTMLDivElement || l.target instanceof HTMLSpanElement, F = l.target === o.current, U = M && l.target.checked !== T;
      if (F || U) {
  ...
  return /* @__PURE__ */ n.exports.createElement(n.exports.Fragment, null, /* @__PURE__ */ n.exports.createElement("div", $({
    ...
    className: A
  }, O)), W && /* @__PURE__ */ n.exports.createElement(Ke, $({
    target: m,
    content: e.tooltip
  }, e.tooltipOptions)));
}));
...
var K = /* @__PURE__ */ n.exports.memo(/* @__PURE__ */ n.exports.forwardRef(function(e, a) {
  var t = e.promptLabel || _("passwordPrompt"), i = e.weakLabel || _("weak"), d = e.mediumLabel || _("medium"), g = e.strongLabel || _("strong"), m = n.exports.useState(!1), o = j(m, 2), c = o[0], b = o[1], y = n.exports.useState(null), P = j(y, 2), x = P[0], N = P[1], W = n.exports.useState(t), R = j(W, 2), k = R[0], E = R[1], A = n.exports.useState(!1), O = j(A, 2), h = O[0], l = O[1], T = n.exports.useState(!1), M = j(T, 2), F = M[0], U = M[1], p = n.exports.useRef(null), w = n.exports.useRef(null), I = n.exports.useRef(e.inputRef), X = n.exports.useRef(new RegExp(e.mediumRegex)), z = n.exports.useRef(new RegExp(e.strongRegex)), le = F ? "text" : "password", ie = Ve({
    target: p,
    overlay: w,
    ...
    e.feedback && qe.emit("overlay-click", {
      originalEvent: r,
      target: p.current
    });
  }, Q = function() {
  ...
  var Ne = function() {
    if (e.toggleMask) {
      var r = F ? "pi pi-eye-slash" : "pi pi-eye", v = /* @__PURE__ */ n.exports.createElement("i", {
        className: r,
        onClick: Q
      });
      if (e.icon) {
    ...
    }, k)), Oe = /* @__PURE__ */ n.exports.createElement(Ue, {
      nodeRef: w,
    ...
    return /* @__PURE__ */ n.exports.createElement(Be, {
      element: Oe,
      appendTo: e.appendTo
    });
...
const nt = () => {
  var N, W, R, k, E, A, O, h;
  const e = We(), a = Ae(), [t, i] = n.exports.useState(""), [d, g] = n.exports.useState(!1), { layoutConfig: m } = n.exports.useContext(je), o = $e(), c = L("surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden", { "p-input-filled": m.inputStyle === "filled" }), { data: b, setData: y, submit: P, processing: x } = Me({
    email: "",
    password: "",
    remember: !1
  });
          ...
          children: [
            ...
            /* @__PURE__ */ s("div", {
              ...
              children: /* @__PURE__ */ s("form", {
                ...
                onSubmit: (l) => {
                  l.preventDefault(), P(He.Method.POST, "");
                },
                children: /* @__PURE__ */ s("div", {
                  children: [
                    /* @__PURE__ */ s("div", {
