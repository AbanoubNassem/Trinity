import { R as h, u as C, a as x, r as m, A as v, l as D, K as R, g as V, j as t, F as I, H as W, B as u } from "./main.74d2364d.js";
import { t as d, T as $ } from "./trinity_link.6e8f244f.js";
import { u as A } from "./trinity_resource_fields.c6ff4e9f.js";
const k = () => {
  var N;
  ...
  const r = R(n);
  m.exports.useEffect(() => {
    o && (c ? V.get("") : d(`/${i == null ? void 0 : i.prefix}/${e == null ? void 0 : e.name}/edit/${o}`, !1, !1));
  }, [o]);
  const T = (a, l) => {
    n[a] = l;
  }, b = (a = !1) => {
    ...
    children: [
      ...
      /* @__PURE__ */ t(u, {
        ...
        onClick: () => d(`/${i.prefix}/${e == null ? void 0 : e.name}`)
      }, void 0, !1, {
        fileName: "/Volumes/Data/Websites/Inertia/Trinity/Trinity-React/src/pages/Create.tsx",
        lineNumber: 70,
        columnNumber: 13
