import { o as b, c as g, g as t, p as w, d as _, r as p, e as l, w as o, f as e, s as h, q as x, v, x as f, t as k, _ as C } from "./main.a429b92d.mjs";
import { s as j, a as u } from "./column.esm.c04bc334.mjs";
var y = {
  name: "Chart",
  emits: ["select", "loaded"],
  props: {
...
const S = { class: "p-chart" }, $ = ["width", "height"];
function N(s, i, n, d, a, m) {
  return b(), g("div", S, [
    t("canvas", w({
      ref: "canvas",
      width: n.width,
